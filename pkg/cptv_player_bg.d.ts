...
export function init_buffer_with_size(a: number): void;
export function insert_chunk_at_offset(a: number, b: number, c: number): void;
export function init_with_cptv_data(a: number, b: number): void;
...
export function get_header(): number;
export function queue_frame(a: number, b: number): number;
export function get_frame(a: number, b: number, c: number): number;
