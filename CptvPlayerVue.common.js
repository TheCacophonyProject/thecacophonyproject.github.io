...
;// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"af619304-vue-loader-template"}!./node_modules/@vue/cli-service/node_modules/@vue/vue-loader-v15/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ruleSet[0].rules[0].use[0]!./node_modules/@vue/cli-service/node_modules/@vue/vue-loader-v15/lib/index.js??vue-loader-options!./src/CptvPlayer.vue?vue&type=template&id=41d975d7&
...
;// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"af619304-vue-loader-template"}!./node_modules/@vue/cli-service/node_modules/@vue/vue-loader-v15/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ruleSet[0].rules[0].use[0]!./node_modules/@vue/cli-service/node_modules/@vue/vue-loader-v15/lib/index.js??vue-loader-options!./src/VideoTracksScrubber.vue?vue&type=template&id=31d627f2&scoped=true&
var VideoTracksScrubbervue_type_template_id_31d627f2_scoped_true_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{key:"track-scrubber",ref:"scrubber",staticClass:"track-scrubber",style:({
    height: (_vm.heightForTracks + "px"),
    width: (_vm.canvasWidth + "px"),
  })},_vm._l((_vm.tracks.length),function(index){return _c('div',{key:index - 1,staticClass:"scrub-track",style:({
      background: _vm.colours[(index - 1) % _vm.colours.length],
      opacity: index - 1 === _vm.currentTrackIndex ? 1.0 : 0.5,
      width: _vm.trackDimensions[index - 1].width,
      left: _vm.trackDimensions[index - 1].left,
      top: ((_vm.trackDimensions[index - 1].top -
        (_vm.numUniqueYSlots === 1 ? 0 : _vm.trackHeight / 2)) + "px"),
    }),attrs:{"title":("Track " + index)}})}),0)}
var VideoTracksScrubbervue_type_template_id_31d627f2_scoped_true_staticRenderFns = []
 ...
 */
function Ref(refKey) {
    return vue_class_component_esm_createDecorator(function (options, key) {
...
;// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js??clonedRuleSet-40[0].rules[0].use[0]!./node_modules/thread-loader/dist/cjs.js!./node_modules/babel-loader/lib/index.js!./node_modules/ts-loader/index.js??clonedRuleSet-40[0].rules[0].use[3]!./node_modules/cache-loader/dist/cjs.js??ruleSet[0].rules[0].use[0]!./node_modules/@vue/cli-service/node_modules/@vue/vue-loader-v15/lib/index.js??vue-loader-options!./src/VideoTracksScrubber.vue?vue&type=script&lang=ts&
...
var getPositionXForEvent = function getPositionXForEvent(event) {
...
var minScrubberHeight = 44;

var VideoTracksScrubber = /*#__PURE__*/function (_Vue) {
  _inherits(VideoTracksScrubber, _Vue);

  var _super = _createSuper(VideoTracksScrubber);

  function VideoTracksScrubber() {
    var _this;

    _classCallCheck(this, VideoTracksScrubber);
    ...
    defineProperty_defineProperty(_assertThisInitialized(_this), "tracks", void 0);

    defineProperty_defineProperty(_assertThisInitialized(_this), "duration", void 0);

    defineProperty_defineProperty(_assertThisInitialized(_this), "currentTrackIndex", void 0);

    defineProperty_defineProperty(_assertThisInitialized(_this), "canvasWidth", void 0);

    defineProperty_defineProperty(_assertThisInitialized(_this), "sidePadding", void 0);

    defineProperty_defineProperty(_assertThisInitialized(_this), "timeAdjustmentForBackgroundFrame", void 0);

    defineProperty_defineProperty(_assertThisInitialized(_this), "colours", void 0);

    defineProperty_defineProperty(_assertThisInitialized(_this), "trackDimensions", []);

    defineProperty_defineProperty(_assertThisInitialized(_this), "numUniqueYSlots", 0);

    defineProperty_defineProperty(_assertThisInitialized(_this), "trackHeight", 12);

    defineProperty_defineProperty(_assertThisInitialized(_this), "scrubber", void 0);

    return _this;
  }

  _createClass(VideoTracksScrubber, [{
    key: "scrubberWidth",
    get: function get() {
    ...
    get: function get() {
      ...
      var paddingY = 10;
      var heightForTracks = this.trackHeight * this.numUniqueYSlots + this.tracks.length - 1;
      return Math.max(44, heightForTracks + paddingY * 2);
    }
  }, {
    key: "getWidthForTrack",
    value: function getWidthForTrack(track) {
      var trackDuration = track.end - this.timeAdjustmentForBackgroundFrame - (track.start - this.timeAdjustmentForBackgroundFrame);
      var ratio = Math.min(1, trackDuration / this.duration);
      return ratio * this.scrubberWidth;
    }
  }, {
    key: "getOffsetXForTrack",
    value: function getOffsetXForTrack(track) {
      return Math.max(this.sidePadding, this.getOffsetForTime(track.start - this.timeAdjustmentForBackgroundFrame) + this.sidePadding);
    }
  }, {
    key: "getOffsetYForTrack",
    value: function getOffsetYForTrack(trackIndex) {
      var _this2 = this;

      // See if there are any gaps to move this up to.
      var topOffset = minScrubberHeight / 2 - this.trackHeight / 2;

      if (trackIndex !== 0) {
        (function () {
          var thisLeft = _this2.getOffsetXForTrack(_this2.tracks[trackIndex]);

          var thisRight = thisLeft + _this2.getWidthForTrack(_this2.tracks[trackIndex]); // Put each track in a slot with the height offset.
          // Then for each new track, go backwards to try and find the earliest slot without a collision.
          // Put the track in that slot.


          var slots = {}; // Go backwards to find the earliest track that has a right <= our left

          while (Math.max(0, trackIndex) !== 0) {
            var lastTrackDims = _this2.trackDimensions[trackIndex - 1];
            var prevLeft = Number(lastTrackDims.left.replace("px", ""));
            var prevRight = prevLeft + Number(lastTrackDims.width.replace("px", ""));
          ...
          var orderedSlots = Object.entries(slots).sort( // eslint-disable-next-line @typescript-eslint/no-unused-vars
          function (_ref, _ref2) {
          ...
          var bestSlot = Number(orderedSlots[0][0]) + _this2.trackHeight + 1;

          for (var i = 0; i < orderedSlots.length; i++) {
            var slot = orderedSlots[i];
            var noOverlaps = slot[1].every(function (_ref5) {
              var _ref6 = _slicedToArray(_ref5, 2),
                  prevLeft = _ref6[0],
                  prevRight = _ref6[1];

              return thisRight < prevLeft || thisLeft > prevRight;
            });
    ...
    key: "getOffsetForTime",
    value: function getOffsetForTime(time) {
      var pixelsPerSecond = this.scrubberWidth / this.duration;
      return Math.min(this.scrubberWidth, this.sidePadding + pixelsPerSecond * time);
    }
  }, {
    key: "pointerMove",
    value: function pointerMove(event) {
      event.preventDefault();
      var bounds = this.scrubber.getBoundingClientRect();
      var x = Math.min(bounds.width, Math.max(0, getPositionXForEvent(event) - bounds.x));
      var timeOffset = x / bounds.width;
    ...
    key: "tearDownScrubber",
    value: function tearDownScrubber() {
      if (this.scrubber) {
    ...
    key: "initTrackDimensions",
    value: function initTrackDimensions() {
      ...
      for (var i = 0; i < this.tracks.length; i++) {
        var yOffset = this.getOffsetYForTrack(i);
        this.trackDimensions.push({
          top: yOffset,
          width: "".concat(this.getWidthForTrack(this.tracks[i]), "px"),
          left: "".concat(this.getOffsetXForTrack(this.tracks[i]), "px")
        });
    ...
    value: function onDurationChanged() {
      this.initTrackDimensions();
    }
  }, {
    key: "onTracksChanged",
    value: function onTracksChanged() {
      this.initTrackDimensions();
    }
  }, {
    key: "onWidthChanged",
...
})], VideoTracksScrubber.prototype, "tracks", void 0);

__decorate([Prop({
  default: 0
})], VideoTracksScrubber.prototype, "duration", void 0);

__decorate([Prop({
  default: 0
})], VideoTracksScrubber.prototype, "currentTrackIndex", void 0);

__decorate([Prop({
  required: true
})], VideoTracksScrubber.prototype, "canvasWidth", void 0);

__decorate([Prop({
  default: 0
})], VideoTracksScrubber.prototype, "sidePadding", void 0);

__decorate([Prop({
  default: 0
})], VideoTracksScrubber.prototype, "timeAdjustmentForBackgroundFrame", void 0);

__decorate([Prop({
  default: function _default() {
    return [];
  }
})], VideoTracksScrubber.prototype, "colours", void 0);

__decorate([Ref()], VideoTracksScrubber.prototype, "scrubber", void 0);

__decorate([Watch("duration")], VideoTracksScrubber.prototype, "onDurationChanged", null);

__decorate([Watch("tracks")], VideoTracksScrubber.prototype, "onTracksChanged", null);

__decorate([Watch("canvasWidth")], VideoTracksScrubber.prototype, "onWidthChanged", null);

VideoTracksScrubber = __decorate([vue_class_component_esm], VideoTracksScrubber);
/* harmony default export */ const VideoTracksScrubbervue_type_script_lang_ts_ = (VideoTracksScrubber);
;// CONCATENATED MODULE: ./src/VideoTracksScrubber.vue?vue&type=script&lang=ts&
 /* harmony default export */ const src_VideoTracksScrubbervue_type_script_lang_ts_ = (VideoTracksScrubbervue_type_script_lang_ts_); 
...
;// CONCATENATED MODULE: ./src/VideoTracksScrubber.vue
...
var component = normalizeComponent(
  src_VideoTracksScrubbervue_type_script_lang_ts_,
  VideoTracksScrubbervue_type_template_id_31d627f2_scoped_true_render,
  VideoTracksScrubbervue_type_template_id_31d627f2_scoped_true_staticRenderFns,
  false,
  null,
  "31d627f2",
  null
...
;// CONCATENATED MODULE: ./src/cptv-decoder/decoder.ts
...
var messageQueue = {};
var decoder;
var CptvDecoder = /*#__PURE__*/function () {
  function CptvDecoder() {
    _classCallCheck(this, CptvDecoder);

    defineProperty_defineProperty(this, "inited", false);

    this.free().then(function () {
      messageQueue = {};
    });
  }

  _createClass(CptvDecoder, [{
    key: "init",
    value: function () {
      var _init = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
        var onMessage, decoderNotInited;
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 2:
                ...
                decoderNotInited = !decoder;

                if (decoderNotInited) {
                  decoder = new Worker(new URL(/* worker import */ __webpack_require__.p + __webpack_require__.u(257), __webpack_require__.b), {
                    type: undefined
                  });
                }
                ...
                _context2.next = 11;
                return this.waitForMessage("init");
    ...
    key: "initWithCptvUrlAndKnownSize",
    value: function () {
      var _initWithCptvUrlAndKnownSize = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(url, size) {
        var type;
        return regeneratorRuntime.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 2:
                type = "initWithUrlAndSize";
                decoder && decoder.postMessage({
                  type: type,
                  url: url,
                  size: size
                });
      ...
      function initWithCptvUrlAndKnownSize(_x2, _x3) {
        return _initWithCptvUrlAndKnownSize.apply(this, arguments);
      }

      return initWithCptvUrlAndKnownSize;
    }() // /**
    //  * Initialises a new player and associated stream reader.
    //  * @param id (Number)
    ...
    key: "initWithCptvUrl",
    value: function () {
      var _initWithCptvUrl = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(url) {
        var type;
      ...
      function initWithCptvUrl(_x4) {
        return _initWithCptvUrl.apply(this, arguments);
      }

      return initWithCptvUrl;
    }()
    /**
    ...
    key: "initWithLocalCptvFile",
    value: function () {
      var _initWithLocalCptvFile = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5(fileBytes) {
        var type;
      ...
      function initWithLocalCptvFile(_x5) {
        return _initWithLocalCptvFile.apply(this, arguments);
      }

      return initWithLocalCptvFile;
    }()
    /**
    ...
    value: function () {
      var _getStreamMetadata = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee6(url) {
        var type;
      ...
      function getStreamMetadata(_x6) {
    ...
    value: function () {
      var _getBytesMetadata = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee7(fileBytes) {
        var type;
    ...
    key: "getNextFrame",
    value: function () {
      var _getNextFrame = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee8() {
        var type;
      ...
      function getNextFrame() {
        return _getNextFrame.apply(this, arguments);
      }
    ...
    key: "getTotalFrames",
    value: function () {
      var _getTotalFrames = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee9() {
        var type;
      ...
      function getTotalFrames() {
        return _getTotalFrames.apply(this, arguments);
      }
    ...
    key: "getHeader",
    value: function () {
      var _getHeader = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee10() {
        var type;
    ...
    key: "getLoadProgress",
    value: function () {
      var _getLoadProgress = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee11() {
        var type;
        return regeneratorRuntime.wrap(function _callee11$(_context11) {
          while (1) {
            switch (_context11.prev = _context11.next) {
              case 0:
                type = "getLoadProgress";
                decoder && decoder.postMessage({
                  type: type
                });
                _context11.next = 4;
      ...
      function getLoadProgress() {
        return _getLoadProgress.apply(this, arguments);
      }
    ...
    key: "hasStreamError",
    value: function () {
      var _hasStreamError = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee12() {
        var type;
    ...
    key: "getStreamError",
    value: function () {
      var _getStreamError = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee13() {
        var type;
      ...
      function getStreamError() {
        return _getStreamError.apply(this, arguments);
      }
    ...
    key: "free",
    value: function () {
      var _free = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee14() {
        var type;
    ...
    key: "waitForMessage",
    value: function () {
      var _waitForMessage = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee15(messageType) {
    ...
    key: "close",
    value: function () {
      var _close = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee16() {
...
var mapRgba = function mapRgba(_ref) {
  var _ref2 = _slicedToArray(_ref, 3),
      r = _ref2[0],
      g = _ref2[1],
      b = _ref2[2];

  return 255 << 24 | b * 255.0 << 16 | g * 255.0 << 8 | r * 255.0;
};

var Viridis = Uint32Array.from(viridis.map(mapRgba));
var Plasma = Uint32Array.from(plasma.map(mapRgba));
var Inferno = Uint32Array.from(inferno.map(mapRgba));
var Magma = Uint32Array.from(magma.map(mapRgba));
var Default = Uint32Array.from(DefaultColourmap.map(function (_ref3) {
...
var GreyscaleSquared = new Uint32Array(256);
var Greyscale = new Uint32Array(256);
...
var ColourMaps = Object.freeze([["Default", Default], ["Viridis", Viridis], ["Plasma", Plasma], ["Inferno", Inferno], ["Magma", Magma], ["Greyscale", Greyscale], ["Grayscale<sup>2</sup>", GreyscaleSquared]]);
/**
...
var renderFrameIntoFrameBuffer = function renderFrameIntoFrameBuffer(targetFrameBuffer, frame, colourMap, min, max) {
  var frameBufferView = new Uint32Array(targetFrameBuffer.buffer);
  var range = max - min;

  for (var _i = 0; _i < targetFrameBuffer.length; _i++) {
    var index = (frame[_i] - min) / range * 255.0;
    var indexUpper = Math.ceil(index);
    frameBufferView[_i] = colourMap[indexUpper];
  }
};
/**
...
var getFrameIndexAtTime = function getFrameIndexAtTime(time, duration, fps, totalFramesIncludingBackground, hasBackgroundFrame) {
  ...
  return Math.floor(Math.min(totalFramesIncludingBackground, time / duration * totalFramesIncludingBackground)) + (hasBackgroundFrame ? -1 : 0);
};
var formatHeaderInfo = function formatHeaderInfo(header) {
  if (header) {
    var width = header.width,
        ...
        previewSecs = header.previewSecs,
        brand = header.brand,
        model = header.model,
        serialNumber = header.serialNumber,
        firmwareVersion = header.firmwareVersion,
        motionConfig = header.motionConfig,
        timestamp = header.timestamp,
        hasBackgroundFrame = header.hasBackgroundFrame,
    ...
    if (brand && model) {
      headerInfo["sensor"] = "".concat(brand, " ").concat(model);
    }

    if (serialNumber) {
      headerInfo["serial"] = "#".concat(serialNumber);
    }
    ...
    if (motionConfig) {
      headerInfo["motion config"] = motionConfig.split("\n").reduce(function (acc, item) {
...
;// CONCATENATED MODULE: ./src/CptvPlayerUtils.ts
...
var PlaybackSpeeds = Object.freeze([0.5, 1, 2, 4, 6]);
var formatTime = function formatTime(time) {
  var seconds = Math.floor(time);

  if (seconds < 60) {
    return "0:".concat("".concat(seconds).padStart(2, "0"));
  }

  var minutes = Math.floor(seconds / 60);
  seconds = seconds - minutes * 60;
  return "".concat(minutes, ":").concat(seconds.toString().padStart(2, "0").padEnd(2, "0"));
};

var getAuthoritativeTagForTrack = function getAuthoritativeTagForTrack(trackTags) {
  var userTags = trackTags.filter(function (tag) {
  ...
  if (userTags.length) {
    ...
    var tag = trackTags.find(function (tag) {
      return tag.data && typeof tag.data === "string" && tag.data === "Master" || _typeof(tag.data) === "object" && tag.data.name && tag.data.name === "Master";
    });
...
var CptvPlayerUtils_formatHeaderInfo = function formatHeaderInfo(header) {
  if (header) {
    var width = header.width,
        height = header.height,
        fps = header.fps,
...
var getPositions = function getPositions(positions, timeOffset, frameTimeSeconds) {
  ...
  if (positions.length > 0 && !Array.isArray(positions[0])) {
    return positions.map(function (position) {
      return [position.frameNumber || position.frameTime && frameAtTime(position.frameTime - timeOffset) || 0, [Math.max(0, position.x - padding), Math.max(0, position.y - padding), position.x + position.width + padding, position.y + position.height + padding]];
    });
  } // Map track box position times to actual frames, easier to use than time offsets.


  return positions.map(function (position) {
    return [frameAtTime(position[0] - timeOffset), [Math.max(0, position[1][0] - padding), Math.max(0, position[1][1] - padding), position[1][2] + padding, position[1][3] + padding]];
  });
};
...
var getProcessedTracks = function getProcessedTracks(tracks, timeOffset, frameTimeSeconds) {
  return tracks.map(function (_ref) {
    ...
    var _iterator = _createForOfIteratorHelper(item.positions),
        _step;
...
function index_es_objectSpread(target) {
...
function index_es_slicedToArray(arr, i) {
  return index_es_arrayWithHoles(arr) || index_es_iterableToArrayLimit(arr, i) || index_es_nonIterableRest();
}

function index_es_toConsumableArray(arr) {
  return index_es_arrayWithoutHoles(arr) || index_es_iterableToArray(arr) || index_es_nonIterableSpread();
}
...
var index_es_WINDOW = _WINDOW;
var index_es_DOCUMENT = _DOCUMENT;
var MUTATION_OBSERVER = _MUTATION_OBSERVER;
var PERFORMANCE = _PERFORMANCE;
var index_es_IS_BROWSER = !!index_es_WINDOW.document;
...
var initial = index_es_WINDOW.FontAwesomeConfig || {};
...
var _config = index_es_objectSpread({}, _default, initial);

if (!_config.autoReplaceSvg) _config.observeMutations = false;

var config = index_es_objectSpread({}, _config);

index_es_WINDOW.FontAwesomeConfig = config;

var w = index_es_WINDOW || {};
...
function handleThenable(promise, value) {
  ...
  try {
    ...
    if (value && (typeof value === 'function' || index_es_typeof(value) === 'object')) {
...
P.resolve = function (value) {
  if (value && index_es_typeof(value) === 'object' && value.constructor === P) {
    return value;
  }
...
function makeIconMasking (_ref) {
  ...
  var maskRect = {
    tag: 'rect',
    attributes: index_es_objectSpread({}, ALL_SPACE, {
      fill: 'white'
    })
  };
  ...
  var maskInnerGroup = {
    tag: 'g',
    attributes: index_es_objectSpread({}, trans.inner),
    children: [fillBlack(index_es_objectSpread({
      tag: mainPath.tag,
      attributes: index_es_objectSpread({}, mainPath.attributes, trans.path)
    }, maskInnerGroupChildrenMixin))]
  };
  var maskOuterGroup = {
    tag: 'g',
    attributes: index_es_objectSpread({}, trans.outer),
  ...
  children.push(defs, {
    tag: 'rect',
    attributes: index_es_objectSpread({
      fill: 'currentColor',
    ...
    children.push({
      ...
      children: [{
        ...
        children: [{
          ...
          attributes: index_es_objectSpread({}, main.icon.attributes, trans.path)
        }]
      }]
    });
  } else {
...
function asIcon (_ref) {
  ...
  if (transformIsMeaningful(transform) && main.found && !mask.found) {
    ...
    attributes['style'] = joinStyles(index_es_objectSpread({}, styles, {
...
function asSymbol (_ref) {
  ...
  return [{
    ...
    children: [{
      tag: 'symbol',
      attributes: index_es_objectSpread({}, attributes, {
        id: id
      }),
      children: children
    }]
...
function makeInlineSvgAbstract(params) {
  ...
  var content = {
    children: [],
    attributes: index_es_objectSpread({}, extra.attributes, {
      'data-prefix': prefix,
      'data-icon': iconName,
      'class': attrClass,
  ...
  var args = index_es_objectSpread({}, content, {
    prefix: prefix,
    iconName: iconName,
    main: main,
    mask: mask,
    ...
    transform: transform,
    symbol: symbol,
    styles: index_es_objectSpread({}, uploadedIconWidthStyle, extra.styles)
  });
...
function makeLayersTextAbstract(params) {
  ...
  var attributes = index_es_objectSpread({}, extra.attributes, title ? {
    'title': title
  } : {}, {
  ...
  var styles = index_es_objectSpread({}, extra.styles);
...
function defineIcons(prefix, icons) {
  ...
  if (typeof namespace.hooks.addPack === 'function' && !skipHooks) {
    ...
    namespace.styles[prefix] = index_es_objectSpread({}, namespace.styles[prefix] || {}, normalized);
  }
  /**
...
function perform(mutations, callback) {
  ...
  if (mutations.length === 0) {
    ...
    if (config.mutateApproach === MUTATION_APPROACH_ASYNC) {
      frame = index_es_WINDOW.requestAnimationFrame || performOperationSync;
    }
...
var RING = {
  tag: 'path',
  attributes: index_es_objectSpread({}, FILL, {
...
var OPACITY_ANIMATE = index_es_objectSpread({}, ANIMATION_BASE, {
...
var DOT = {
  ...
  children: [{
    tag: 'animate',
    attributes: index_es_objectSpread({}, ANIMATION_BASE, {
      attributeName: 'r',
      values: '28;14;28;28;14;28;'
    })
  }, {
    tag: 'animate',
    attributes: index_es_objectSpread({}, OPACITY_ANIMATE, {
      values: '1;0;1;1;0;1;'
    })
  }]
};
...
function replaceForPosition(node, position) {
  ...
  return new picked(function (resolve, reject) {
    ...
    var styles = index_es_WINDOW.getComputedStyle(node, position);
    ...
    if (alreadyProcessedPseudoElement && !fontFamily) {
      ...
      if (iconName && (!alreadyProcessedPseudoElement || alreadyProcessedPseudoElement.getAttribute(DATA_PREFIX) !== prefix || alreadyProcessedPseudoElement.getAttribute(DATA_ICON) !== iconIdentifier)) {
        ...
        findIcon(iconName, prefix).then(function (main) {
          var abstract = makeInlineSvgAbstract(index_es_objectSpread({}, meta, {
            icons: {
              main: main,
  ...
  index_es_createClass(Library, [{
    ...
    value: function add() {
      ...
      Object.keys(additions).forEach(function (key) {
        _this.definitions[key] = index_es_objectSpread({}, _this.definitions[key] || {}, additions[key]);
...
function resolveIcons(next) {
  return function (maybeIconDefinition) {
    ...
    return next(iconDefinition, index_es_objectSpread({}, params, {
      mask: mask
    }));
  };
}
...
var icon = resolveIcons(function (iconDefinition) {
  ...
  return apiObject(index_es_objectSpread({
    type: 'icon'
    ...
    return makeInlineSvgAbstract({
      ...
      prefix: prefix,
      iconName: iconName,
      transform: index_es_objectSpread({}, meaninglessTransform, transform),
      symbol: symbol,
      title: title,
      maskId: maskId,
      titleId: titleId,
...
var vue_fontawesome_index_es_typeof = typeof Symbol === "function" && typeof Symbol.iterator === "symbol" ? function (obj) {
  return typeof obj;
} : function (obj) {
  return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj;
};
...
function normalizeIconArgs(icon$$1) {
  ...
  if ((typeof icon$$1 === 'undefined' ? 'undefined' : vue_fontawesome_index_es_typeof(icon$$1)) === 'object' && icon$$1.prefix && icon$$1.iconName) {
    return icon$$1;
  }
...
// EXTERNAL MODULE: ./node_modules/@fortawesome/free-solid-svg-icons/faAngleRight.js
var faAngleRight = __webpack_require__(3183);
...
var faInfoCircle = __webpack_require__(2414);
// EXTERNAL MODULE: ./node_modules/@fortawesome/free-solid-svg-icons/faPlay.js
var faPlay = __webpack_require__(753);
// EXTERNAL MODULE: ./node_modules/@fortawesome/free-solid-svg-icons/faPause.js
var faPause = __webpack_require__(6043);
// EXTERNAL MODULE: ./node_modules/@fortawesome/free-solid-svg-icons/faPalette.js
var faPalette = __webpack_require__(7450);
// EXTERNAL MODULE: ./node_modules/@fortawesome/free-solid-svg-icons/faSpinner.js
var faSpinner = __webpack_require__(2332);
// EXTERNAL MODULE: ./node_modules/@fortawesome/free-solid-svg-icons/faRedoAlt.js
var faRedoAlt = __webpack_require__(2581);
// EXTERNAL MODULE: ./node_modules/@fortawesome/free-solid-svg-icons/faFolderOpen.js
var faFolderOpen = __webpack_require__(8792);
// EXTERNAL MODULE: ./node_modules/@fortawesome/free-solid-svg-icons/faImage.js
var faImage = __webpack_require__(8076);
// EXTERNAL MODULE: ./node_modules/@fortawesome/free-solid-svg-icons/faFileVideo.js
var faFileVideo = __webpack_require__(4980);
// EXTERNAL MODULE: ./node_modules/@fortawesome/free-solid-svg-icons/faWrench.js
var faWrench = __webpack_require__(8302);
// EXTERNAL MODULE: ./node_modules/@fortawesome/free-solid-svg-icons/faChartBar.js
var faChartBar = __webpack_require__(9186);
// EXTERNAL MODULE: ./node_modules/@fortawesome/free-solid-svg-icons/faStepForward.js
var faStepForward = __webpack_require__(946);
// EXTERNAL MODULE: ./node_modules/@fortawesome/free-solid-svg-icons/faStepBackward.js
var faStepBackward = __webpack_require__(4687);
...
/* harmony default export */ const icons = (FontAwesomeIcon);
...
;// CONCATENATED MODULE: ./node_modules/bootstrap-vue/src/vue.js

 // --- Constants ---

var COMPONENT_UID_KEY = '_uid';

;// CONCATENATED MODULE: ./node_modules/bootstrap-vue/src/constants/components.js
// Component names
...
var env_HAS_PROMISE_SUPPORT = typeof Promise !== 'undefined';
...
var env_IS_BROWSER = HAS_WINDOW_SUPPORT && HAS_DOCUMENT_SUPPORT && HAS_NAVIGATOR_SUPPORT;
...
var env_IS_IE = /msie|trident/.test(USER_AGENT); // Determine if the browser supports the option passive for events
...
var HAS_TOUCH_SUPPORT = env_IS_BROWSER && ('ontouchstart' in env_DOCUMENT.documentElement || NAVIGATOR.maxTouchPoints > 0);
var HAS_POINTER_EVENT_SUPPORT = env_IS_BROWSER && Boolean(env_WINDOW.PointerEvent || env_WINDOW.MSPointerEvent);
/* istanbul ignore next: JSDOM only checks for 'IntersectionObserver' */

var HAS_INTERACTION_OBSERVER_SUPPORT = env_IS_BROWSER && 'IntersectionObserver' in env_WINDOW && 'IntersectionObserverEntry' in env_WINDOW && // Edge 15 and UC Browser lack support for `isIntersecting`
// but we an use `intersectionRatio > 0` instead
// 'isIntersecting' in window.IntersectionObserverEntry.prototype &&
'intersectionRatio' in env_WINDOW.IntersectionObserverEntry.prototype;
;// CONCATENATED MODULE: ./node_modules/bootstrap-vue/src/constants/events.js
...
;// CONCATENATED MODULE: ./node_modules/bootstrap-vue/src/constants/key-codes.js
...
;// CONCATENATED MODULE: ./node_modules/bootstrap-vue/src/constants/props.js
...
var File = HAS_WINDOW_SUPPORT ? env_WINDOW.File : /*#__PURE__*/function (_Object2) {
...
;// CONCATENATED MODULE: ./node_modules/bootstrap-vue/src/constants/slots.js
...
var inspect_isPrimitive = function isPrimitive(value) {
  return isBoolean(value) || inspect_isString(value) || isNumber(value);
};
...
;// CONCATENATED MODULE: ./node_modules/bootstrap-vue/src/utils/string.js
...
var string_upperFirst = function upperFirst(str) {
  str = inspect_isString(str) ? str.trim() : String(str);
  return str.charAt(0).toUpperCase() + str.slice(1);
...
var string_toString = function toString(val) {
  ...
  return isUndefinedOrNull(val) ? '' : inspect_isArray(val) || isPlainObject(val) && val.toString === Object.prototype.toString ? JSON.stringify(val, null, spaces) : String(val);
...
var isVisible = function isVisible(el) {
  if (!isElement(el) || !el.parentNode || !contains(env_DOCUMENT.body, el)) {
...
var selectAll = function selectAll(selector, root) {
  return from((isElement(root) ? root : env_DOCUMENT).querySelectorAll(selector));
}; // Select a single element, returns `null` if not found

var dom_select = function select(selector, root) {
  return (isElement(root) ? root : env_DOCUMENT).querySelector(selector) || null;
...
var contains = function contains(parent, child) {
  return parent && inspect_isFunction(parent.contains) ? parent.contains(child) : false;
...
;// CONCATENATED MODULE: ./node_modules/bootstrap-vue/src/utils/events.js
...
var object_defineProperty = function defineProperty(obj, prop, descriptor) {
...
var omit = function omit(obj, props) {
  return keys(obj).filter(function (key) {
    ...
    return _objectSpread2(_objectSpread2({}, result), {}, defineProperty_defineProperty({}, key, obj[key]));
  }, {});
...
var cloneDeep = function cloneDeep(obj) {
  ...
  if (isPlainObject(obj)) {
    return keys(obj).reduce(function (result, key) {
      return _objectSpread2(_objectSpread2({}, result), {}, defineProperty_defineProperty({}, key, cloneDeep(obj[key], obj[key])));
    }, {});
  }
...
;// CONCATENATED MODULE: ./node_modules/bootstrap-vue/src/utils/props.js
...
var makePropsConfigurable = function makePropsConfigurable(props, componentKey) {
  return keys(props).reduce(function (result, key) {
    return _objectSpread2(_objectSpread2({}, result), {}, defineProperty_defineProperty({}, key, makePropConfigurable(props[key], key, componentKey)));
  }, {});
...
var hasPropFunction = function hasPropFunction(fn) {
  return inspect_isFunction(fn) && fn.name !== configurablePropDefaultFnName;
};
;// CONCATENATED MODULE: ./node_modules/bootstrap-vue/src/utils/model.js
...
var makeModelMixin = function makeModelMixin(prop) {
  ...
  var props = defineProperty_defineProperty({}, prop, makeProp(type, defaultValue, validator)); // @vue/component
...
;// CONCATENATED MODULE: ./node_modules/bootstrap-vue/src/utils/env.js
/**
...
var makePropCacheMixin = function makePropCacheMixin(propName, proxyPropName) {
  return external_commonjs_vue_commonjs2_vue_root_Vue_default().extend({
    data: function data() {
      return defineProperty_defineProperty({}, proxyPropName, cloneDeep(this[propName]));
    },
    watch: defineProperty_defineProperty({}, propName, makePropWatcher(proxyPropName))
  });
};
...
;// CONCATENATED MODULE: ./node_modules/bootstrap-vue/src/mixins/listen-on-document.js
...
var listenOnDocumentMixin = external_commonjs_vue_commonjs2_vue_root_Vue_default().extend({
  ...
  methods: {
    ...
    listenOnDocument: function listenOnDocument(eventName, handler) {
      if (this[PROP] && inspect_isString(eventName) && inspect_isFunction(handler)) {
...
;// CONCATENATED MODULE: ./node_modules/bootstrap-vue/src/mixins/listen-on-window.js
...
var listenOnWindowMixin = external_commonjs_vue_commonjs2_vue_root_Vue_default().extend({
  ...
  methods: {
    ...
    listenOnWindow: function listenOnWindow(eventName, handler) {
      if (env_IS_BROWSER && this[listen_on_window_PROP] && inspect_isString(eventName) && inspect_isFunction(handler)) {
...
;// CONCATENATED MODULE: ./node_modules/bootstrap-vue/src/utils/get-scope-id.js
...
;// CONCATENATED MODULE: ./node_modules/bootstrap-vue/src/mixins/scoped-style.js
...
var scopedStyleMixin = external_commonjs_vue_commonjs2_vue_root_Vue_default().extend({
  computed: {
    scopedStyleAttrs: function scopedStyleAttrs() {
      ...
      return scopeId ? defineProperty_defineProperty({}, scopeId, '') : {};
    }
  }
});
...
;// CONCATENATED MODULE: ./node_modules/bootstrap-vue/src/mixins/listeners.js
...
var link_props = makePropsConfigurable(sortKeys(_objectSpread2(_objectSpread2(_objectSpread2({}, nuxtLinkProps), routerLinkProps), {}, {
...
var BLink = /*#__PURE__*/external_commonjs_vue_commonjs2_vue_root_Vue_default().extend({
  ...
  render: function render(h) {
    var active = this.active,
        disabled = this.disabled;
    return h(this.computedTag, defineProperty_defineProperty({
      class: {
        active: active,
        disabled: disabled
      },
...
var button_props = makePropsConfigurable(sortKeys(_objectSpread2(_objectSpread2({}, linkProps), {}, {
...
var button_close_props = makePropsConfigurable({
...
var BButtonClose = /*#__PURE__*/external_commonjs_vue_commonjs2_vue_root_Vue_default().extend({
  ...
  render: function render(h, _ref) {
    ...
    var componentData = {
      staticClass: 'close',
      class: defineProperty_defineProperty({}, "text-".concat(props.textVariant), props.textVariant),
      attrs: {
        type: 'button',
...
;// CONCATENATED MODULE: ./node_modules/bootstrap-vue/src/components/transition/bv-transition.js
...
var BVTransition = /*#__PURE__*/external_commonjs_vue_commonjs2_vue_root_Vue_default().extend({
...
;// CONCATENATED MODULE: ./node_modules/bootstrap-vue/src/components/transporter/transporter.js
...
var BVTransporterTarget = /*#__PURE__*/external_commonjs_vue_commonjs2_vue_root_Vue_default().extend({
  ...
  render: function render(h) {
    ...
    var $nodes = inspect_isFunction(updatedNodes) ? updatedNodes({}) : updatedNodes;
    $nodes = concat($nodes).filter(identity_identity);
...
var BVTransporter = /*#__PURE__*/external_commonjs_vue_commonjs2_vue_root_Vue_default().extend({
  ...
  methods: {
    ...
    getContainer: function getContainer() {
      ...
      if (env_IS_BROWSER) {
        ...
        return inspect_isString(container) ? dom_select(container) : container;
      } else {
        return null;
      }
    },
    ...
    updateTarget: function updateTarget() {
      if (env_IS_BROWSER && this.$_target) {
  ...
  render: function render(h) {
    ...
    if (this.disabled) {
      var $nodes = concat(this.normalizeSlot()).filter(identity_identity);
...
;// CONCATENATED MODULE: ./node_modules/bootstrap-vue/src/utils/number.js
...
var ModalManager = /*#__PURE__*/external_commonjs_vue_commonjs2_vue_root_Vue_default().extend({
  ...
  methods: {
    ...
    getBaseZIndex: function getBaseZIndex() {
      if (isNull(this.baseZIndex) && env_IS_BROWSER) {
    ...
    getScrollbarWidth: function getScrollbarWidth() {
      if (isNull(this.scrollbarWidth) && env_IS_BROWSER) {
    ...
    setScrollbar: function setScrollbar() {
      ...
      if (this.isBodyOverflowing) {
        ...
        selectAll(SELECTOR_FIXED_CONTENT).forEach(function (el) {
          ...
          setStyle(el, 'paddingRight', "".concat(number_toFloat(getCS(el).paddingRight, 0) + scrollbarWidth, "px"));
        ...
        /* istanbul ignore next */
        {
          ...
          setStyle(el, 'marginRight', "".concat(number_toFloat(getCS(el).marginRight, 0) - scrollbarWidth, "px"));
        ...
        setStyle(body, 'paddingRight', "".concat(number_toFloat(getCS(body).paddingRight, 0) + scrollbarWidth, "px"));
      }
    },
...
var modal_props = makePropsConfigurable(sortKeys(_objectSpread2(_objectSpread2(_objectSpread2({}, props), modelProps), {}, {
...
var BModal = /*#__PURE__*/external_commonjs_vue_commonjs2_vue_root_Vue_default().extend({
  ...
  computed: {
    ...
    dialogClasses: function dialogClasses() {
      ...
      return [(_ref = {}, defineProperty_defineProperty(_ref, "modal-".concat(this.size), this.size), defineProperty_defineProperty(_ref, 'modal-dialog-centered', this.centered), defineProperty_defineProperty(_ref, 'modal-dialog-scrollable', this.scrollable), _ref), this.dialogClass];
    },
    headerClasses: function headerClasses() {
      var _ref2;

      return [(_ref2 = {}, defineProperty_defineProperty(_ref2, "bg-".concat(this.headerBgVariant), this.headerBgVariant), defineProperty_defineProperty(_ref2, "text-".concat(this.headerTextVariant), this.headerTextVariant), defineProperty_defineProperty(_ref2, "border-".concat(this.headerBorderVariant), this.headerBorderVariant), _ref2), this.headerClass];
    },
    ...
    bodyClasses: function bodyClasses() {
      ...
      return [(_ref3 = {}, defineProperty_defineProperty(_ref3, "bg-".concat(this.bodyBgVariant), this.bodyBgVariant), defineProperty_defineProperty(_ref3, "text-".concat(this.bodyTextVariant), this.bodyTextVariant), _ref3), this.bodyClass];
    },
    footerClasses: function footerClasses() {
      var _ref4;

      return [(_ref4 = {}, defineProperty_defineProperty(_ref4, "bg-".concat(this.footerBgVariant), this.footerBgVariant), defineProperty_defineProperty(_ref4, "text-".concat(this.footerTextVariant), this.footerTextVariant), defineProperty_defineProperty(_ref4, "border-".concat(this.footerBorderVariant), this.footerBorderVariant), _ref4), this.footerClass];
    },
    ...
    computeIgnoreEnforceFocusSelector: function computeIgnoreEnforceFocusSelector() {
      ...
      return concat(this.ignoreEnforceFocusSelector).filter(identity_identity).join(',').trim();
    },
    computedAttrs: function computedAttrs() {
  ...
  watch: defineProperty_defineProperty({}, MODEL_PROP_NAME, function (newValue, oldValue) {
  ...
  methods: {
    ...
    getActiveElement: function getActiveElement() {
      ...
      var activeElement = dom_getActiveElement(env_IS_BROWSER ? [document.body] : []); // Preset the fallback return focus value if it is not set
    ...
    returnFocusTo: function returnFocusTo() {
      ...
      this.$nextTick(function () {
        ...
        el = inspect_isString(el) ? dom_select(el) : el;
...
;// CONCATENATED MODULE: ./node_modules/bootstrap-vue/src/utils/css-escape.js
...
var form_state_props = makePropsConfigurable({
...
var generateProps = function generateProps() {
  ...
  var breakpoints = getBreakpointsUpCached().filter(identity_identity); // i.e. 'col-sm', 'col-md-6', 'col-lg-auto', ...
...
var BCol = {
  ...
  render: function render(h, _ref) {
    ...
    }, defineProperty_defineProperty(_classList$push, "col-".concat(cols), cols), defineProperty_defineProperty(_classList$push, "offset-".concat(offset), offset), defineProperty_defineProperty(_classList$push, "order-".concat(order), order), defineProperty_defineProperty(_classList$push, "align-self-".concat(alignSelf), alignSelf), _classList$push));
...
var form_row_props = makePropsConfigurable({
  tag: makeProp(PROP_TYPE_STRING, 'div')
}, NAME_FORM_ROW); // --- Main component ---
// @vue/component

var BFormRow = /*#__PURE__*/external_commonjs_vue_commonjs2_vue_root_Vue_default().extend({
  name: NAME_FORM_ROW,
  functional: true,
...
var form_text_props = makePropsConfigurable({
  id: makeProp(PROP_TYPE_STRING),
...
var BFormText = /*#__PURE__*/external_commonjs_vue_commonjs2_vue_root_Vue_default().extend({
  name: NAME_FORM_TEXT,
  functional: true,
  ...
  render: function render(h, _ref) {
    var props = _ref.props,
        ...
        children = _ref.children;
    return h(props.tag, a(data, {
      class: defineProperty_defineProperty({
...
var form_invalid_feedback_props = makePropsConfigurable({
...
var BFormInvalidFeedback = /*#__PURE__*/external_commonjs_vue_commonjs2_vue_root_Vue_default().extend({
...
var form_valid_feedback_props = makePropsConfigurable({
  ariaLive: makeProp(PROP_TYPE_STRING),
  forceShow: makeProp(PROP_TYPE_BOOLEAN, false),
  id: makeProp(PROP_TYPE_STRING),
  role: makeProp(PROP_TYPE_STRING),
...
var BFormValidFeedback = /*#__PURE__*/external_commonjs_vue_commonjs2_vue_root_Vue_default().extend({
...
var form_group_generateProps = function generateProps() {
  return makePropsConfigurable(sortKeys(_objectSpread2(_objectSpread2(_objectSpread2(_objectSpread2({}, props), form_state_props), getBreakpointsUpCached().reduce(function (props, breakpoint) {
...
var BFormGroup = {
  ...
  methods: {
    getAlignClasses: function getAlignClasses(props, prefix) {
      return getBreakpointsUpCached().reduce(function (result, breakpoint) {
        ...
        if (propValue) {
          result.push(['text', breakpoint, propValue].filter(identity_identity).join('-'));
        }
    ...
    updateAriaDescribedby: function updateAriaDescribedby(newValue, oldValue) {
      ...
      if (env_IS_BROWSER && labelFor) {
        // We need to escape `labelFor` since it can be user-provided
        var $input = dom_select("#".concat(cssEscape(labelFor)), this.$refs.content);
        ...
        if ($input) {
          ...
          }).filter(identity_identity).join(' ').trim();
  ...
  render: function render(h) {
    ...
    var ariaDescribedby = this.ariaDescribedby = [descriptionId, state === false ? invalidFeedbackId : null, state === true ? validFeedbackId : null].filter(identity_identity).join(' ') || null;
...
;// CONCATENATED MODULE: ./node_modules/bootstrap-vue/src/mixins/form-control.js
...
var form_control_props = makePropsConfigurable({
...
var form_custom_props = makePropsConfigurable({
  plain: makeProp(PROP_TYPE_BOOLEAN, false)
}, 'formControls'); // --- Mixin ---
// @vue/component

var formCustomMixin = external_commonjs_vue_commonjs2_vue_root_Vue_default().extend({
...
var form_size_props = makePropsConfigurable({
  size: makeProp(PROP_TYPE_STRING)
}, 'formControls'); // --- Mixin ---
// @vue/component
...
var form_radio_check_makeModelMixin = makeModelMixin('checked', {
  defaultValue: null
}),
...
var form_radio_check_props = makePropsConfigurable(sortKeys(_objectSpread2(_objectSpread2(_objectSpread2(_objectSpread2(_objectSpread2(_objectSpread2(_objectSpread2({}, props), form_radio_check_modelProps), form_control_props), form_size_props), form_state_props), form_custom_props), {}, {
  ariaLabel: makeProp(PROP_TYPE_STRING),
...
var formRadioCheckMixin = external_commonjs_vue_commonjs2_vue_root_Vue_default().extend({
  ...
  watch: (_watch = {}, defineProperty_defineProperty(_watch, form_radio_check_MODEL_PROP_NAME, function () {
    this["".concat(form_radio_check_MODEL_PROP_NAME, "Watcher")].apply(this, arguments);
  }), defineProperty_defineProperty(_watch, "computedLocalChecked", function computedLocalChecked() {
    this.computedLocalCheckedWatcher.apply(this, arguments);
  }), _watch),
  methods: (_methods = {}, defineProperty_defineProperty(_methods, "".concat(form_radio_check_MODEL_PROP_NAME, "Watcher"), function Watcher(newValue) {
    if (!looseEqual(newValue, this.computedLocalChecked)) {
      this.computedLocalChecked = newValue;
    }
  }), defineProperty_defineProperty(_methods, "computedLocalCheckedWatcher", function computedLocalCheckedWatcher(newValue, oldValue) {
    if (!looseEqual(newValue, oldValue)) {
      this.$emit(form_radio_check_MODEL_EVENT_NAME, newValue);
    }
  }), defineProperty_defineProperty(_methods, "handleChange", function handleChange(_ref2) {
    var _this = this;
  ...
  }), defineProperty_defineProperty(_methods, "handleFocus", function handleFocus(event) {
  ...
  }), defineProperty_defineProperty(_methods, "focus", function focus() {
    if (!this.isDisabled) {
      attemptFocus(this.$refs.input);
    }
  }), defineProperty_defineProperty(_methods, "blur", function blur() {
    if (!this.isDisabled) {
...
var form_checkbox_objectSpread2;
...
var BFormCheckbox = /*#__PURE__*/external_commonjs_vue_commonjs2_vue_root_Vue_default().extend({
  ...
  computed: {
    isChecked: function isChecked() {
      ...
      return inspect_isArray(checked) ? looseIndexOf(checked, value) > -1 : looseEqual(checked, value);
    },
    isRadio: function isRadio() {
      return false;
    }
  },
  watch: defineProperty_defineProperty({}, MODEL_PROP_NAME_INDETERMINATE, function (newValue, oldValue) {
    if (!looseEqual(newValue, oldValue)) {
  ...
  methods: {
    ...
    handleChange: function handleChange(_ref) {
      ...
      if (inspect_isArray(localChecked)) {
    ...
    setIndeterminate: function setIndeterminate(state) {
      ...
      if (inspect_isArray(this.computedLocalChecked)) {
        state = false;
      }
...
var form_file_makeModelMixin = makeModelMixin('value', {
  type: [PROP_TYPE_ARRAY, File],
  defaultValue: null,
  validator: function validator(value) {
    /* istanbul ignore next */
    if (value === '') {
      warn_warn(VALUE_EMPTY_DEPRECATED_MSG, NAME_FORM_FILE);
      return true;
    }
...
var isValidValue = function isValidValue(value) {
  return isFile(value) || inspect_isArray(value) && value.every(function (v) {
...
var getDataTransferItemEntry = function getDataTransferItemEntry(item) {
  return inspect_isFunction(item.getAsEntry) ? item.getAsEntry() : inspect_isFunction(item.webkitGetAsEntry) ? item.webkitGetAsEntry() : null;
...
var form_file_props = makePropsConfigurable(sortKeys(_objectSpread2(_objectSpread2(_objectSpread2(_objectSpread2(_objectSpread2(_objectSpread2(_objectSpread2({}, props), form_file_modelProps), form_control_props), form_custom_props), form_state_props), form_size_props), {}, {
...
var BFormFile = /*#__PURE__*/external_commonjs_vue_commonjs2_vue_root_Vue_default().extend({
  name: NAME_FORM_FILE,
  ...
  computed: {
    ...
    computedAccept: function computedAccept() {
      ...
      accept = (accept || '').trim().split(/[,\s]+/).filter(identity_identity); // Allow any file type/extension
  ...
  watch: (form_file_watch = {}, defineProperty_defineProperty(form_file_watch, form_file_MODEL_PROP_NAME, function (newValue) {
    if (!newValue || inspect_isArray(newValue) && newValue.length === 0) {
      this.reset();
    }
  }), defineProperty_defineProperty(form_file_watch, "files", function files(newValue, oldValue) {
    if (!looseEqual(newValue, oldValue)) {
  ...
  methods: {
    ...
    isFilesArrayValid: function isFilesArrayValid(files) {
      ...
      return inspect_isArray(files) ? files.every(function (file) {
    ...
    onChange: function onChange(event) {
      ...
      if (env_HAS_PROMISE_SUPPORT && items.length > 0 && !isNull(getDataTransferItemEntry(items[0]))) {
  ...
  render: function render(h) {
    ...
    return h('div', {
      ...
      class: [defineProperty_defineProperty({}, "b-custom-control-".concat(size), size), stateClass, bvAttrs.class],
      style: bvAttrs.style,
      attrs: {
...
;// CONCATENATED MODULE: ./node_modules/bootstrap-vue/src/utils/math.js
...
var progress_bar_props = makePropsConfigurable({
...
var BProgressBar = /*#__PURE__*/external_commonjs_vue_commonjs2_vue_root_Vue_default().extend({
  ...
  computed: {
    ...
    computedValue: function computedValue() {
      return number_toFloat(this.value, 0);
    },
    computedMax: function computedMax() {
      // Prefer our max over parent setting
      // Default to `100` for invalid values (`-x`, `0`, `NaN`)
      var max = number_toFloat(this.max) || number_toFloat(this.bvProgress.max, 0);
...
var progressBarProps = omit(progress_bar_props, ['label', 'labelHtml']);
var progress_props = makePropsConfigurable(sortKeys(_objectSpread2(_objectSpread2({}, progressBarProps), {}, {
...
var BProgress = /*#__PURE__*/external_commonjs_vue_commonjs2_vue_root_Vue_default().extend({
  name: NAME_PROGRESS,
  mixins: [normalizeSlotMixin],
...
var getTarget = function getTarget(_ref) {
  ...
  return inspect_isString(value) ? value : inspect_isString(arg) ? arg : keys(modifiers).reverse()[0];
};
...
;// CONCATENATED MODULE: ./src/mp4-export.ts
...
var Mp4Encoder = /*#__PURE__*/function () {
  function Mp4Encoder() {
    var _this = this;

    _classCallCheck(this, Mp4Encoder);

    defineProperty_defineProperty(this, "encoder", void 0);

    defineProperty_defineProperty(this, "messageQueue", {});

    this.encoder = new Worker(new URL(/* worker import */ __webpack_require__.p + __webpack_require__.u(612), __webpack_require__.b));

    this.encoder.onmessage = function (_ref) {
      var _ref$data = _ref.data,
          type = _ref$data.type,
          data = _ref$data.data;
      var resolver = _this.messageQueue[type];
      delete _this.messageQueue[type];
      resolver && resolver(data);
    };
  }

  _createClass(Mp4Encoder, [{
    key: "waitForMessage",
    value: function () {
      var _waitForMessage = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(messageType) {
        var _this2 = this;
    ...
    key: "init",
    value: function () {
      var _init = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(width, height, frameRate) {
        var type;
        return regeneratorRuntime.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
    ...
    key: "encodeFrame",
    value: function () {
      var _encodeFrame = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(frame) {
        var type;
        return regeneratorRuntime.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
      ...
      function encodeFrame(_x5) {
        return _encodeFrame.apply(this, arguments);
      }
    ...
    key: "finish",
    value: function () {
      var _finish = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4() {
        var type;
        return regeneratorRuntime.wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
...
;// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js??clonedRuleSet-40[0].rules[0].use[0]!./node_modules/thread-loader/dist/cjs.js!./node_modules/babel-loader/lib/index.js!./node_modules/ts-loader/index.js??clonedRuleSet-40[0].rules[0].use[3]!./node_modules/cache-loader/dist/cjs.js??ruleSet[0].rules[0].use[0]!./node_modules/@vue/cli-service/node_modules/@vue/vue-loader-v15/lib/index.js??vue-loader-options!./src/CptvPlayer.vue?vue&type=script&lang=ts&
...
var CptvPlayervue_type_script_lang_ts_decorate = undefined && undefined.__decorate || function (decorators, target, key, desc) {
  var c = arguments.length,
      r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc,
      d;
  if ((typeof Reflect === "undefined" ? "undefined" : _typeof(Reflect)) === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);else for (var i = decorators.length - 1; i >= 0; i--) {
...
var lastCptvUrl = null;
var frameBuffer;
var CptvPlayervue_type_script_lang_ts_frames = [];
var cptvDecoder;

var CptvPlayerComponent = /*#__PURE__*/function (_Vue) {
  _inherits(CptvPlayerComponent, _Vue);

  var _super = _createSuper(CptvPlayerComponent);

  function CptvPlayerComponent() {
    var _this;

    _classCallCheck(this, CptvPlayerComponent);
    ...
    defineProperty_defineProperty(_assertThisInitialized(_this), "extLoading", void 0);

    defineProperty_defineProperty(_assertThisInitialized(_this), "cptvUrl", void 0);

    defineProperty_defineProperty(_assertThisInitialized(_this), "cptvSize", void 0);

    defineProperty_defineProperty(_assertThisInitialized(_this), "colours", void 0);

    defineProperty_defineProperty(_assertThisInitialized(_this), "canSelectTracks", void 0);

    defineProperty_defineProperty(_assertThisInitialized(_this), "showOverlaysForCurrentTrackOnly", void 0);

    defineProperty_defineProperty(_assertThisInitialized(_this), "standAlone", void 0);

    defineProperty_defineProperty(_assertThisInitialized(_this), "tracks", void 0);

    defineProperty_defineProperty(_assertThisInitialized(_this), "currentTrack", void 0);

    defineProperty_defineProperty(_assertThisInitialized(_this), "knownDuration", void 0);

    defineProperty_defineProperty(_assertThisInitialized(_this), "recordingId", void 0);

    defineProperty_defineProperty(_assertThisInitialized(_this), "recentlyAddedTag", void 0);

    defineProperty_defineProperty(_assertThisInitialized(_this), "canGoBackwards", void 0);

    defineProperty_defineProperty(_assertThisInitialized(_this), "canGoForwards", void 0);

    defineProperty_defineProperty(_assertThisInitialized(_this), "exportRequested", void 0);

    defineProperty_defineProperty(_assertThisInitialized(_this), "canUseAdvancedControls", void 0);

    defineProperty_defineProperty(_assertThisInitialized(_this), "userFiles", void 0);

    defineProperty_defineProperty(_assertThisInitialized(_this), "container", void 0);

    defineProperty_defineProperty(_assertThisInitialized(_this), "canvas", void 0);

    defineProperty_defineProperty(_assertThisInitialized(_this), "overlayCanvas", void 0);

    defineProperty_defineProperty(_assertThisInitialized(_this), "playhead", void 0);

    defineProperty_defineProperty(_assertThisInitialized(_this), "valueTooltip", void 0);

    defineProperty_defineProperty(_assertThisInitialized(_this), "frameNumField", void 0);

    defineProperty_defineProperty(_assertThisInitialized(_this), "ffcSecsAgo", void 0);

    defineProperty_defineProperty(_assertThisInitialized(_this), "openUserDefinedCptvFile", true);

    defineProperty_defineProperty(_assertThisInitialized(_this), "userSuppliedFile", null);

    defineProperty_defineProperty(_assertThisInitialized(_this), "header", null);

    defineProperty_defineProperty(_assertThisInitialized(_this), "frameHeader", null);

    defineProperty_defineProperty(_assertThisInitialized(_this), "atEndOfPlayback", false);

    defineProperty_defineProperty(_assertThisInitialized(_this), "canvasWidth", 800);

    defineProperty_defineProperty(_assertThisInitialized(_this), "canvasHeight", 600);

    defineProperty_defineProperty(_assertThisInitialized(_this), "showAtEndOfSearch", false);

    defineProperty_defineProperty(_assertThisInitialized(_this), "isScrubbing", false);

    defineProperty_defineProperty(_assertThisInitialized(_this), "ended", false);

    defineProperty_defineProperty(_assertThisInitialized(_this), "smoothed", true);

    defineProperty_defineProperty(_assertThisInitialized(_this), "showValueInfo", false);
    ...
    defineProperty_defineProperty(_assertThisInitialized(_this), "speedMultiplierIndex", 1);

    defineProperty_defineProperty(_assertThisInitialized(_this), "paletteIndex", 0);

    defineProperty_defineProperty(_assertThisInitialized(_this), "animationFrame", null);

    defineProperty_defineProperty(_assertThisInitialized(_this), "messageAnimationFrame", null);
    ...
    defineProperty_defineProperty(_assertThisInitialized(_this), "showAdvancedControls", false);

    defineProperty_defineProperty(_assertThisInitialized(_this), "showDebugTools", false);

    defineProperty_defineProperty(_assertThisInitialized(_this), "displayHeaderInfo", false);

    defineProperty_defineProperty(_assertThisInitialized(_this), "loadProgress", 0);

    defineProperty_defineProperty(_assertThisInitialized(_this), "playerMessage", null);

    defineProperty_defineProperty(_assertThisInitialized(_this), "messageTimeout", null);
    ...
    defineProperty_defineProperty(_assertThisInitialized(_this), "exportProgress", 0);

    defineProperty_defineProperty(_assertThisInitialized(_this), "showingHistogram", false);

    defineProperty_defineProperty(_assertThisInitialized(_this), "globalClampedMin", undefined);

    defineProperty_defineProperty(_assertThisInitialized(_this), "loadedStream", false);

    defineProperty_defineProperty(_assertThisInitialized(_this), "streamLoadError", null);

    defineProperty_defineProperty(_assertThisInitialized(_this), "scrubberSidePadding", 1);

    defineProperty_defineProperty(_assertThisInitialized(_this), "devicePixelRatio", 1);

    defineProperty_defineProperty(_assertThisInitialized(_this), "windowWidth", window.innerWidth);

    defineProperty_defineProperty(_assertThisInitialized(_this), "showAdvancedExportOptions", false);

    defineProperty_defineProperty(_assertThisInitialized(_this), "minValue", Number.MAX_VALUE);

    defineProperty_defineProperty(_assertThisInitialized(_this), "maxValue", Number.MIN_VALUE);

    defineProperty_defineProperty(_assertThisInitialized(_this), "trackExportOptions", []);

    defineProperty_defineProperty(_assertThisInitialized(_this), "scale", 1);

    defineProperty_defineProperty(_assertThisInitialized(_this), "raqFps", 60);

    defineProperty_defineProperty(_assertThisInitialized(_this), "polledFps", false);
  ...
  _createClass(CptvPlayerComponent, [{
    key: "frameNum",
    get: function get() {
      return this.internalFrameNum; // if (this.totalFrames !== null) {
      //   return Math.min(this.internalFrameNum, this.totalFrames);
      // }
      // return this.internalFrameNum;
    },
    set: function set(num) {
      this.internalFrameNum = num; // if (this.totalFrames !== null) {
    ...
    key: "playheadOffsetForCurrentTime",
    get: function get() {
      var pixelsPerSecond = this.scrubberWidth / this.actualDuration;
      return this.scrubberSidePadding + Math.min(this.scrubberWidth, pixelsPerSecond * this.currentTime60fps);
    }
  }, {
    key: "hasStreamLoadError",
    get: function get() {
    ...
    get: function get() {
      ...
      if (this.header !== null) {
        ...
        if (this.header.totalFrames) {
          var totalPlayableFrames = this.header.totalFrames - (this.header.hasBackgroundFrame ? 1 : 0);
          return totalPlayableFrames / fps;
        } else {
          if (this.totalFrames !== null) {
            return (this.totalFrames - 1 - (this.header.hasBackgroundFrame ? 1 : 0)) / fps;
          }
      ...
      return Math.max.apply(Math, _toConsumableArray(this.tracks.map(function (track) {
        return track.end - _this2.timeAdjustmentForBackgroundFrame;
      })).concat([this.duration - this.timeAdjustmentForBackgroundFrame]));
    }
  }, {
    key: "timeAdjustmentForBackgroundFrame",
    get: function get() {
      if (this.hasBackgroundFrame) {
    ...
    get: function get() {
      return this.header && this.header.hasBackgroundFrame || false;
    }
  }, {
    key: "duration",
    get: function get() {
    ...
    key: "currentTime60fps",
    get: function get() {
      if (this.header) {
        var holdForXFrames = Math.ceil(this.raqFps / (this.header.fps * this.speedMultiplier));
    ...
    get: function get() {
      if (this.header) {
        var totalTime = this.actualDuration;
        var totalFramesEstimate = totalTime * this.header.fps;
    ...
    get: function get() {
      if (this.frameHeader && this.frameHeader.frameTempC) {
        return "About ".concat(Math.round(this.frameHeader.frameTempC), "\xBAC");
      }

      return false;
    }
  }, {
    key: "secondsSinceLastFFC",
    get: function get() {
    ...
    key: "headerInfo",
    get: function get() {
      return CptvPlayerUtils_formatHeaderInfo(this.header);
    }
  }, {
    key: "exportOptions",
    get: function get() {
    ...
    value: function created() {
      ...
      var smoothingPreference = window.localStorage.getItem("video-smoothing");

      if (smoothingPreference) {
        this.smoothed = smoothingPreference === "true";
      }

      var palettePreference = window.localStorage.getItem("video-palette");

      if (palettePreference) {
        this.paletteIndex = ColourMaps.findIndex(function (_ref2) {
          var _ref3 = _slicedToArray(_ref2, 1),
              name = _ref3[0];

          return name === palettePreference;
        });
        this.colourMap = ColourMaps[this.paletteIndex];
      }

      var playbackSpeed = window.localStorage.getItem("video-playback-speed");
    ...
    value: function () {
      var _mounted = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
        ...
        var frameTimes, pollFrameTimes, match;
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                pollFrameTimes = function pollFrameTimes() {
                  if (!_this3.polledFps) {
                    ...
                    if (frameTimes.length < 10) {
                      ...
                      for (var _i = 0, _diffs = diffs; _i < _diffs.length; _i++) {
                        var val = _diffs[_i];
                        total += val;
                      } // Get the average frame time


                      var multiplier = Math.round(1000 / (total / diffs.length) / 30);
                      ...
                      _this3.polledFps = true;
                    }
                  }
                };

                pollFrameTimes();
                window.addEventListener("load", pollFrameTimes); // This makes button active styles work in safari iOS.
                ...
                if (this.canSelectTracks) {
                  ...
                  this.overlayCanvas.addEventListener("mousemove", this.moveOverOverlayCanvas);
                }
    ...
    key: "beforeDestroy",
    value: function () {
      var _beforeDestroy = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
        var match;
        return regeneratorRuntime.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                if (this.canSelectTracks) {
                  ...
                  this.overlayCanvas.removeEventListener("mousemove", this.moveOverOverlayCanvas);
                }
                ...
                if (window.matchMedia) {
                  ...
                  match.removeEventListener && match.removeEventListener("change", this.setCanvasDimensions);
                }

                cancelAnimationFrame(this.animationFrame);
                _context2.next = 9;
                return cptvDecoder.close();

              case 9:
                CptvPlayervue_type_script_lang_ts_frames = [];
    ...
    value: function () {
      var _ensureEntireFileIsLoaded = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3() {
        var _this$header;
        ...
        return regeneratorRuntime.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                if (!((_this$header = this.header) !== null && _this$header !== void 0 && _this$header.totalFrames)) {
                  _context3.next = 14;
                  break;
                }
              ...
              case 22:
                this.totalFrames = _context3.sent;

                if (!this.totalFrames) {
                  CptvPlayervue_type_script_lang_ts_frames.push(_frame);
                }
              ...
              case 27:
                if (!this.totalFrames) {
                  this.totalFrames = CptvPlayervue_type_script_lang_ts_frames.length;
                }
      ...
      function ensureEntireFileIsLoaded() {
        return _ensureEntireFileIsLoaded.apply(this, arguments);
      }

      return ensureEntireFileIsLoaded;
    }()
  }, {
    key: "onExportRequested",
    value: function () {
      var _onExportRequested = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4() {
        return regeneratorRuntime.wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                ...
                if (!(this.tracks && this.tracks.length && this.exportRequested === "advanced")) {
                  _context4.next = 6;
                  break;
                }
      ...
      function onExportRequested() {
        return _onExportRequested.apply(this, arguments);
      }

      return onExportRequested;
    }()
  }, {
    key: "onUserSuppliedFileChanged",
    value: function () {
      var _onUserSuppliedFileChanged = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5() {
        var buffer;
        return regeneratorRuntime.wrap(function _callee5$(_context5) {
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
                ...
                this.buffering = true;
                _context5.next = 5;
                return this.userSuppliedFile.arrayBuffer();
              ...
              case 8:
                _context5.next = 10;
                return this.loadCptvFile(new Uint8Array(buffer), false);

              case 10:
                _context5.next = 12;
                return this.ensureEntireFileIsLoaded();

              case 12:
                _context5.next = 14;
                return cptvDecoder.hasStreamError();
              ...
              case 14:
                ...
                _context5.next = 17;
                return cptvDecoder.getStreamError();

              case 17:
                this.streamLoadError = _context5.sent;
                _context5.t0 = cptvDecoder;
                ...
                _context5.next = 22;
                return cptvDecoder.free();

              case 22:
                this.buffering = false; // Still allow truncated files to play if they have frames, but show an error message.
      ...
      function onUserSuppliedFileChanged() {
        return _onUserSuppliedFileChanged.apply(this, arguments);
      }

      return onUserSuppliedFileChanged;
    }()
  }, {
    key: "onCurrentTrack",
    value: function onCurrentTrack() {
      if (this.playing) {
    ...
    key: "onRecentlyAddedTag",
    value: function onRecentlyAddedTag() {
      // Update the box label for a recently added tag
      this.renderOverlay(this.overlayCanvas.getContext("2d"), this.scale, this.secondsSinceLastFFC, false, this.frameNum);
    }
  }, {
    key: "onCptvUrl",
    value: function onCptvUrl() {
    ...
    key: "onTracks",
    value: function onTracks() {
      this.trackExportOptions = this.exportOptions;
    }
  }, {
    key: "dismissAnyTooltips",
    value: function dismissAnyTooltips() {
      this.$root.$emit("bv::hide::tooltip");
    }
  }, {
    key: "initTrackExportOptions",
    value: function initTrackExportOptions() {
      this.trackExportOptions = this.exportOptions;
    }
  }, {
    key: "firstFrameForTrack",
    value: function firstFrameForTrack(trackId) {
      var frameForTrack = Object.entries(this.processedTracks // eslint-disable-next-line @typescript-eslint/no-unused-vars
        ...
        return Object.keys(tracks).map(Number).includes(trackId);
      });
      return frameForTrack && Number(frameForTrack[0]) || 0;
    }
  }, {
    key: "onePastLastFrameForTrack",
    value: function onePastLastFrameForTrack(trackId) {
    ...
    key: "initPlayer",
    value: function () {
      var _initPlayer = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee6() {
        return regeneratorRuntime.wrap(function _callee6$(_context6) {
          while (1) {
            switch (_context6.prev = _context6.next) {
              case 0:
    ...
    key: "loadCptvFile",
    value: function () {
      var _loadCptvFile = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee7() {
        var localFile,
            playImmediately,
            _args7 = arguments;
        return regeneratorRuntime.wrap(function _callee7$(_context7) {
          while (1) {
            switch (_context7.prev = _context7.next) {
              case 0:
                localFile = _args7.length > 0 && _args7[0] !== undefined ? _args7[0] : null;
                playImmediately = _args7.length > 1 && _args7[1] !== undefined ? _args7[1] : true;
                ...
                _context7.next = 6;
                return cptvDecoder.initWithCptvUrlAndKnownSize(this.cptvUrl, this.cptvSize || 0);

              case 6:
                this.loadedStream = _context7.sent;
              ...
              case 9:
                _context7.next = 11;
                return cptvDecoder.initWithLocalCptvFile(localFile);
              ...
              case 28:
                ...
                _context7.t0 = Object;
                _context7.next = 33;
                return cptvDecoder.getHeader();

              case 33:
                _context7.t1 = _context7.sent;
                this.header = _context7.t0.freeze.call(_context7.t0, _context7.t1);
                this.setFrameInfo(0);
                this.scale = this.canvasWidth / this.header.width;
                this.$emit("ready-to-play", this.header);
                frameBuffer = new Uint8ClampedArray(this.header.width * this.header.height * 4);
      ...
      function loadCptvFile() {
        return _loadCptvFile.apply(this, arguments);
      }
    ...
    value: function getFrameAtIndex(i) {
      var frameIndex = this.hasBackgroundFrame ? Math.min(CptvPlayervue_type_script_lang_ts_frames.length - 1, i + 1) : Math.min(CptvPlayervue_type_script_lang_ts_frames.length - 1, i); //console.log("Asking for frame index", i);
      ...
      var withinFfcTimeout = frame.meta.lastFfcTimeMs && frame.meta.timeOnMs - frame.meta.lastFfcTimeMs < 5000;
      ...
      if (minValue !== 0 && (frame.meta.isBackgroundFrame || !withinFfcTimeout)) {
        ...
        var AVERAGE_HEADROOM_OVER_BACKGROUND = 300;
        this.maxValue = Math.max(Math.max(this.maxValue, maxValue), Math.min(1 << 16, this.minValue + AVERAGE_HEADROOM_OVER_BACKGROUND));
      }
    ...
    value: function selectTrack() {
      ...
      var shouldPlay = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
      ...
      if (this.currentTrack && (!this.playing || force)) {
        if (this.currentTrack.start !== undefined) {
          if (this.processedTracks) {
            cancelAnimationFrame(this.animationFrame);
            this.animationTick = 0;
            this.setTimeAndRedraw(-1, this.firstFrameForTrack(this.currentTrack.trackId));
    ...
    key: "toggleHistogram",
    value: function toggleHistogram() {
      this.showingHistogram = !this.showingHistogram;
    }
  }, {
    key: "stepForward",
    value: function () {
      var _stepForward = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee8() {
        var canAdvance;
        return regeneratorRuntime.wrap(function _callee8$(_context8) {
          while (1) {
            switch (_context8.prev = _context8.next) {
      ...
      function stepForward() {
        return _stepForward.apply(this, arguments);
      }
    ...
    key: "stepBackward",
    value: function () {
      var _stepBackward = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee9() {
        var firstFrame, couldStep;
        return regeneratorRuntime.wrap(function _callee9$(_context9) {
          while (1) {
            switch (_context9.prev = _context9.next) {
              case 0:
                ...
                firstFrame = 0;
                _context9.next = 6;
                return this.renderCurrentFrame(true, Math.max(this.frameNum - 1, firstFrame));

              case 6:
                couldStep = _context9.sent;
      ...
      function stepBackward() {
        return _stepBackward.apply(this, arguments);
      }

      return stepBackward;
    }()
  }, {
    key: "clickOverlayCanvas",
    value: function () {
      var _clickOverlayCanvas = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee10(event) {
        var canvasOffset, x, y, trackId;
        return regeneratorRuntime.wrap(function _callee10$(_context10) {
          while (1) {
            switch (_context10.prev = _context10.next) {
              case 0:
                ...
                trackId = this.getTrackIdAtPosition(x, y);
      ...
      function clickOverlayCanvas(_x) {
        return _clickOverlayCanvas.apply(this, arguments);
      }

      return clickOverlayCanvas;
    }()
  }, {
    key: "clearCanvas",
    ...
    value: function moveOverOverlayCanvas(event) {
      var canvasOffset = this.canvas.getBoundingClientRect();
      var x = event.x - canvasOffset.x;
      var y = event.y - canvasOffset.y;
      var hitTrackIndex = this.getTrackIdAtPosition(x, y); // set cursor
      ...
      if (this.showValueInfo && this.header) {
        ...
        if (x > canvasOffset.right - canvasOffset.x - 100) {
          this.valueTooltip.style.left = "".concat(x - 100, "px");
        } else {
          this.valueTooltip.style.left = "".concat(x + 2, "px");
        }

        if (y < canvasOffset.top - canvasOffset.y + 20) {
          this.valueTooltip.style.top = "".concat(y + 20, "px");
        } else {
          this.valueTooltip.style.top = "".concat(y - 20, "px");
        }
      }
    ...
    key: "fetchRenderAdvanceFrame",
    value: function () {
      var _fetchRenderAdvanceFrame = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee11() {
        var canAdvance;
        return regeneratorRuntime.wrap(function _callee11$(_context11) {
          while (1) {
            switch (_context11.prev = _context11.next) {
      ...
      function fetchRenderAdvanceFrame() {
        return _fetchRenderAdvanceFrame.apply(this, arguments);
      }

      return fetchRenderAdvanceFrame;
    }()
  }, {
    key: "toggleAdvancedControls",
    value: function toggleAdvancedControls() {
    ...
    value: function minMaxForFrame(_ref10) {
      ...
      var lastFfcTimeMs = meta.lastFfcTimeMs || 1000000;
      var timeSinceLastFFC = (meta.timeOnMs - lastFfcTimeMs) / 1000;
    ...
    key: "exportMp4",
    value: function () {
      var _exportMp = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee12(trackExportOptions) {
        var _this4 = this;
          ...
          while (1) {
            switch (_context12.prev = _context12.next) {
              ...
              case 2:
                ...
                _context12.next = 11;
                return encoder.init(targetWidth, targetHeight, this.header.fps);
              ...
              case 11:
                ...
                encoder.close(); // Check for cancellation
              ...
              case 31:
                this.streamLoadError = _context12.sent;
                _context12.next = 34;
                return cptvDecoder.free();
              ...
              case 40:
                ...
                startFrame = 0;
                onePastLastFrame = totalFrames;

                if (trackExportOptions && trackExportOptions.filter(function (track) {
                  return track.includeInExportTime;
                }).length !== 0) {
                  ...
                  try {
                    _loop = function _loop() {
                      var _step$value = _step.value,
                          ...
                          trackId = _step$value.trackId;

                      if (includeInExportTime) {
                        var track = _this4.tracks.find(function (track) {
                          return track.id === trackId;
                        });

                        if (track) {
                          var startTrackFrame = _this4.getFrameAtTime(track.start - 1);

                          var endTrackFrame = _this4.getFrameAtTime(track.end + 1);
              ...
              case 46:
                if (!(frameNum < onePastLastFrame)) {
                  _context12.next = 67;
                  break;
                }

                frameData = this.getFrameAtIndex(frameNum);
                frameHeader = frameData.meta;
                _this$minMaxForFrame = this.minMaxForFrame(frameData), _this$minMaxForFrame2 = _slicedToArray(_this$minMaxForFrame, 2), min = _this$minMaxForFrame2[0], max = _this$minMaxForFrame2[1];
                renderFrameIntoFrameBuffer(frameBuffer, frameData.data, this.colourMap[1], min, max);
                videoContext.putImageData(new ImageData(frameBuffer, this.header.width, this.header.height), 0, 0);
                ...
                context.drawImage(videoCanvas, 0, 0, videoCanvas.width, videoCanvas.height, 0, 0, renderCanvas.width, renderCanvas.height); // Draw the overlay

                timeSinceLastFFCSeconds = Number.MAX_SAFE_INTEGER;

                if (frameHeader.lastFfcTimeMs) {
                  timeSinceLastFFCSeconds = (frameHeader.timeOnMs - frameHeader.lastFfcTimeMs) / 1000;
                }

                this.renderOverlay(context, renderCanvas.width / videoCanvas.width, timeSinceLastFFCSeconds, true, frameNum, trackExportOptions);
                _context12.next = 60;
                return encoder.encodeFrame(context.getImageData(0, 0, targetWidth, targetHeight).data);
              ...
              case 63:
                this.exportProgress = (frameNum - startFrame) / (onePastLastFrame - startFrame);
                frameNum++;
                _context12.next = 46;
                break;
              ...
              case 73:
                ...
                this.initTrackExportOptions();
                recordingIdSuffix = this.recordingId !== null ? "recording_".concat(this.recordingId, "__") : "";
                download(URL.createObjectURL(new Blob([uint8Array], {
                  type: "video/mp4"
                })), "".concat(recordingIdSuffix).concat(new Date(this.header.timestamp / 1000).toLocaleString()));
                this.isExporting = false;
      ...
      function exportMp4(_x2) {
        return _exportMp.apply(this, arguments);
      }
    ...
    value: function renderFrame(frameData, frameNum) {
      ...
      if (this.canvas && this.header) {
        ...
        var min;
        var max; // FIXME - remove as any when def updated

        if (this.header.minValue && this.header.maxValue) {
          min = this.header.minValue;
          max = this.header.maxValue;
        } else {
          var _this$minMaxForFrame3 = this.minMaxForFrame(frameData);

          var _this$minMaxForFrame4 = _slicedToArray(_this$minMaxForFrame3, 2);

          min = _this$minMaxForFrame4[0];
          max = _this$minMaxForFrame4[1];
        }

        var range = max - min;
        var colourMap = this.colourMap[1];
        var fd = frameData.data;
        var frameBufferView = new Uint32Array(frameBuffer.buffer);
        var len = frameBufferView.length;

        for (var i = 0; i < len; i++) {
          var index = (fd[i] - min) / range * 255.0;
        ...
        this.animationFrame = requestAnimationFrame(function () {
          if (_this5.header) {
            _this5.drawFrame(context, new ImageData(frameBuffer, _this5.header.width, _this5.header.height), frameNum || _this5.frameNum, force);
          }
        });
      }
    }
    ...
    key: "drawFrame",
    value: function () {
      var _drawFrame = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee13(context, imgData, frameNum) {
        var _this6 = this;
        ...
        return regeneratorRuntime.wrap(function _callee13$(_context13) {
          while (1) {
            switch (_context13.prev = _context13.next) {
              case 0:
                force = _args13.length > 3 && _args13[3] !== undefined ? _args13[3] : false;
                ...
                everyXTicks = Math.max(1, Math.floor(this.raqFps / (this.header.fps * this.speedMultiplier))); // NOTE: respect fps here, render only when we should.

                shouldRedraw = (this.animationTick + (this.playing ? 1 : 0)) % everyXTicks === 0; //console.log("Should redraw", shouldRedraw, this.animationTick, this.playing);
                ...
                this.setFrameInfo(frameNum); //console.log("*** Draw frame to canvas", frameNum);
                //debugger;
              ...
              case 14:
                ...
                if (this.header && this.totalFrames && this.frameNum == totalExcludingBackground) {
              ...
              case 19:
                if (context) {
                  ...
                  cancelAnimationFrame(this.animationFrame);
                  this.animationFrame = requestAnimationFrame(function () {
                    return _this6.drawFrame(context, imgData, frameNum);
                  });
                }
              ...
              case 20:
                ...
                if (playhead) {
                  playheadContext = playhead.getContext("2d");

                  if (playheadContext) {
                    playheadContext.fillStyle = "rgba(0, 0, 0, 0.35)";
                    playheadContext.clearRect(0, 0, playhead.width, playhead.height);
                    playheadX = this.playheadOffsetForCurrentTime * this.devicePixelRatio;
      ...
      function drawFrame(_x3, _x4, _x5) {
        return _drawFrame.apply(this, arguments);
      }
    ...
    key: "setFrameInfo",
    value: function setFrameInfo(frameNum) {
      if (this.showDebugTools) {
        if (this.frameNumField) {
          this.frameNumField.innerText = "Frame #".concat(frameNum);
        }

        if (this.ffcSecsAgo && this.secondsSinceLastFFC) {
          this.ffcSecsAgo.innerText = "FFC ".concat(this.secondsSinceLastFFC.toFixed(1), "s ago");
        }
      }
    }
  }, {
    ...
    value: function incrementSpeed() {
      ...
      this.setPlayerMessage("Speed ".concat(PlaybackSpeeds[this.speedMultiplierIndex], "x"));
      window.localStorage.setItem("video-playback-speed", PlaybackSpeeds[this.speedMultiplierIndex].toString());
    }
  }, {
    key: "incrementPalette",
    value: function () {
      var _incrementPalette = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee14() {
        var paletteName;
        return regeneratorRuntime.wrap(function _callee14$(_context14) {
          while (1) {
            switch (_context14.prev = _context14.next) {
              case 0:
                ...
                paletteName = ColourMaps[this.paletteIndex][0];
      ...
      function incrementPalette() {
        return _incrementPalette.apply(this, arguments);
      }

      return incrementPalette;
    }()
  }, {
    key: "showHeaderInfo",
    value: function showHeaderInfo() {
    ...
    value: function setPlayerMessage(message) {
      ...
      if (this.messageTimeout !== null || this.playerMessage !== null) {
        ...
        this.messageAnimationFrame = requestAnimationFrame(function () {
          _this7.setPlayerMessage(message);
        });
      } else {
        this.playerMessage = message;
        this.messageTimeout = setTimeout(function () {
          _this7.messageTimeout = null;
          _this7.playerMessage = null;
        }, 1000);
      }
    }
  }, {
    key: "renderOverlay",
    value: function renderOverlay(context, scale, timeSinceFFCSeconds, isExporting, frameNum, trackExportOptions) {
      var _this8 = this;
      ...
      if (context) {
        ...
        var frameTracks = Object.entries(tracks);

        if (this.currentTrack && !isExporting && this.canSelectTracks && frameTracks.length === 1) {
          var trackId = Number(frameTracks[0][0]); // If the track is the only track at this time offset, make it the selected track.
        ...
        if (this.currentTrack && (!this.showOverlaysForCurrentTrackOnly || isExporting)) {
          var _iterator2 = _createForOfIteratorHelper(frameTracks),
              _step2;
          ...
          try {
            var _loop2 = function _loop2() {
              var _step2$value = _slicedToArray(_step2.value, 2),
                  ...
                  trackBox = _step2$value[1];

              if (_this8.currentTrack.trackId !== Number(trackId)) {
                var _trackExportOptions$f;

                if (!trackExportOptions || (_trackExportOptions$f = trackExportOptions.find(function (options) {
                  return options.trackId === Number(trackId);
                })) !== null && _trackExportOptions$f !== void 0 && _trackExportOptions$f.displayInExport) {
                  var box = trackBox;

                  _this8.drawRectWithText(context, Number(trackId), box.rect, box.what, isExporting);
                }
              }
            };
        ...
        var _loop3 = function _loop3() {
          var _frameTracks$_i = _slicedToArray(_frameTracks[_i2], 2),
              trackId = _frameTracks$_i[0],
              trackBox = _frameTracks$_i[1];

          if (_this8.currentTrack && _this8.currentTrack.trackId === Number(trackId)) {
            var _trackExportOptions$f2;

            if (!trackExportOptions || (_trackExportOptions$f2 = trackExportOptions.find(function (options) {
              return options.trackId === Number(trackId);
            })) !== null && _trackExportOptions$f2 !== void 0 && _trackExportOptions$f2.displayInExport) {
              var box = trackBox;
        ...
        for (var _i2 = 0, _frameTracks = frameTracks; _i2 < _frameTracks.length; _i2++) {
          _loop3();
        }
        ...
        if (timeSinceFFCSeconds !== null && timeSinceFFCSeconds < 10) {
          ...
          a = a * a;
          var alpha = 1 - a;
          context.fillStyle = "rgba(163, 210, 226, ".concat(alpha, ")");
          var text = "Calibrating...";
          var textWidth = context.measureText(text).width;
          var deviceRatio = isExporting ? 1 : window.devicePixelRatio;
          var textX = context.canvas.width / deviceRatio / 2 - textWidth / 2;
          var textY = 20;
    ...
    key: "drawRectWithText",
    value: function drawRectWithText(context, trackId, dims, what, isExporting) {
      if (!this.header) {
        return;
      }

      var selected = this.currentTrack && this.currentTrack.trackId === trackId || isExporting;
      var trackIndex = this.tracks.findIndex(function (track) {
        return track.id === trackId;
      });
      var lineWidth = selected ? 2 : 1;
      var outlineWidth = lineWidth + 4;
      var halfOutlineWidth = outlineWidth / 2;
      var deviceRatio = isExporting ? 1 : window.devicePixelRatio;
      var scale = context.canvas.width / this.header.width;

      var _dims$map = dims.map(function (x) {
        return x * scale;
      }),
          _dims$map2 = _slicedToArray(_dims$map, 4),
          left = _dims$map2[0],
          top = _dims$map2[1],
          right = _dims$map2[2],
          bottom = _dims$map2[3];
      ...
      var x = Math.max(halfOutlineWidth, Math.round(left) - halfOutlineWidth) / deviceRatio;
      var y = Math.max(halfOutlineWidth, Math.round(top) - halfOutlineWidth) / deviceRatio;
      var width = Math.round(Math.min(context.canvas.width - left, Math.round(rectWidth))) / deviceRatio;
      var height = Math.round(Math.min(context.canvas.height - top, Math.round(rectHeight))) / deviceRatio;
      context.lineJoin = "round";
      context.lineWidth = outlineWidth;
      context.strokeStyle = "rgba(0, 0, 0, ".concat(selected ? 0.4 : 0.5, ")");
      context.beginPath();
      ...
      if (selected || isExporting) {
        ...
        if (what !== null) {
          var text = what;
          var textHeight = 9 * deviceRatio;
          var textWidth = context.measureText(text).width * deviceRatio;
          var marginX = 2 * deviceRatio;
          var marginTop = 2 * deviceRatio;
          var textX = Math.min(context.canvas.width, right) - (textWidth + marginX);
          var textY = bottom + textHeight + marginTop; // Make sure the text doesn't get clipped off if the box is near the frame edges
    ...
    value: function toggleSmoothing() {
      ...
      this.setPlayerMessage("Smoothing ".concat(this.smoothed ? "Enabled" : "Disabled"));
    }
  }, {
    key: "togglePicker",
    ...
    value: function () {
      var _toggleBackground = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee15() {
        var background, context, _this$minMaxForFrame5, _this$minMaxForFrame6, min, max, overlayContext;
      ...
      function toggleBackground() {
        return _toggleBackground.apply(this, arguments);
      }

      return toggleBackground;
    }()
  }, {
    key: "getTrackIdAtPosition",
    value: function getTrackIdAtPosition(x, y) {
      var _this9 = this;

      var tracks = this.processedTracks[this.frameNum] || {};

      for (var _i3 = 0, _Object$entries = Object.entries(tracks); _i3 < _Object$entries.length; _i3++) {
        var _Object$entries$_i = _slicedToArray(_Object$entries[_i3], 2),
            trackId = _Object$entries$_i[0],
            trackBox = _Object$entries$_i[1];

        var box = trackBox;

        var _box$rect$map = box.rect.map(function (x) {
          return x * _this9.scale;
        }),
            _box$rect$map2 = _slicedToArray(_box$rect$map, 4),
            left = _box$rect$map2[0],
            top = _box$rect$map2[1],
            right = _box$rect$map2[2],
            bottom = _box$rect$map2[3];
    ...
    value: function setCanvasDimensions() {
      ...
      var context = canvas.getContext("2d");
      this.container.style.maxHeight = "".concat(this.canvasHeight, "px");
    ...
    value: function getFrameAtTime(time) {
      if (this.header) {
        return getFrameIndexAtTime(time, this.actualDuration, this.header.fps, this.loadedFrames, this.header.hasBackgroundFrame);
      }

      return 0;
    }
  }, {
    key: "setTimeAndRedraw",
    value: function () {
      var _setTimeAndRedraw = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee16() {
        var time,
            frameNum,
            totalFrames,
            _args16 = arguments;
        return regeneratorRuntime.wrap(function _callee16$(_context16) {
          while (1) {
            switch (_context16.prev = _context16.next) {
              case 0:
                time = _args16.length > 0 && _args16[0] !== undefined ? _args16[0] : -1;
                frameNum = _args16.length > 1 && _args16[1] !== undefined ? _args16[1] : -1;
                ...
                totalFrames = this.totalFrames && this.totalFrames - (this.header.hasBackgroundFrame ? 1 : 0);
                ...
                if (time !== -1 && this.actualDuration !== 0) {
                  this.frameNum = Math.floor(Math.min(totalFrames, time / this.actualDuration * totalFrames));
                } else if (frameNum !== -1) {
                  this.frameNum = frameNum;
                }

                this.atEndOfPlayback = this.frameNum === totalFrames - 1; //console.log("At end?", this.frameNum, totalFrames - 1);
      ...
      function setTimeAndRedraw() {
        return _setTimeAndRedraw.apply(this, arguments);
      }

      return setTimeAndRedraw;
    }()
  }, {
    key: "renderCurrentFrame",
    value: function () {
      var _renderCurrentFrame = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee17() {
        var force,
            frameNum,
            frame,
            gotFrame,
          ...
          while (1) {
            switch (_context17.prev = _context17.next) {
              case 0:
                ...
                frameNum = _args17.length > 1 ? _args17[1] : undefined;
                ...
                _context17.next = 5;
                return cptvDecoder.getLoadProgress();

              case 5:
                this.loadProgress = _context17.sent;
              ...
              case 20:
                this.totalFrames = _context17.sent;
                this.totalFrames = this.totalFrames && this.totalFrames + (this.header.hasBackgroundFrame ? 1 : 0);
              ...
              case 28:
                this.streamLoadError = _context17.sent;
                _context17.next = 31;
                return cptvDecoder.free();
              ...
              case 37:
                ...
                this.buffering = false;
                gotFrame = frameNum < this.loadedFrames;
                frameData = this.getFrameAtIndex(frameNum);
                this.frameHeader = frameData.meta;
                this.renderFrame(frameData, frameNum, force);
                return _context17.abrupt("return", gotFrame);
      ...
      function renderCurrentFrame() {
        return _renderCurrentFrame.apply(this, arguments);
      }
    ...
    key: "play",
    value: function () {
      var _play = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee18() {
    ...
    key: "togglePlayback",
    value: function () {
      var _togglePlayback = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee19() {
    ...
    key: "requestPrevRecording",
    value: function requestPrevRecording() {
    ...
    key: "requestNextRecording",
    value: function requestNextRecording() {
  ...
  return CptvPlayerComponent;
}((external_commonjs_vue_commonjs2_vue_root_Vue_default()));

CptvPlayervue_type_script_lang_ts_decorate([Prop({
  default: false
})], CptvPlayerComponent.prototype, "extLoading", void 0);

CptvPlayervue_type_script_lang_ts_decorate([Prop({
  default: null
})], CptvPlayerComponent.prototype, "cptvUrl", void 0);

CptvPlayervue_type_script_lang_ts_decorate([Prop({
  default: null
})], CptvPlayerComponent.prototype, "cptvSize", void 0);

CptvPlayervue_type_script_lang_ts_decorate([Prop({
  default: function _default() {
    return [];
  }
})], CptvPlayerComponent.prototype, "colours", void 0);

CptvPlayervue_type_script_lang_ts_decorate([Prop({
  default: true
})], CptvPlayerComponent.prototype, "canSelectTracks", void 0);

CptvPlayervue_type_script_lang_ts_decorate([Prop({
  default: false
})], CptvPlayerComponent.prototype, "showOverlaysForCurrentTrackOnly", void 0);

CptvPlayervue_type_script_lang_ts_decorate([Prop({
  default: false
})], CptvPlayerComponent.prototype, "standAlone", void 0);

CptvPlayervue_type_script_lang_ts_decorate([Prop({
  default: function _default() {
    return [];
  }
})], CptvPlayerComponent.prototype, "tracks", void 0);

CptvPlayervue_type_script_lang_ts_decorate([Prop()], CptvPlayerComponent.prototype, "currentTrack", void 0);

CptvPlayervue_type_script_lang_ts_decorate([Prop({
  default: null
})], CptvPlayerComponent.prototype, "knownDuration", void 0);

CptvPlayervue_type_script_lang_ts_decorate([Prop({
  default: null
})], CptvPlayerComponent.prototype, "recordingId", void 0);

CptvPlayervue_type_script_lang_ts_decorate([Prop({
  default: null
})], CptvPlayerComponent.prototype, "recentlyAddedTag", void 0);

CptvPlayervue_type_script_lang_ts_decorate([Prop({
  default: false
})], CptvPlayerComponent.prototype, "canGoBackwards", void 0);

CptvPlayervue_type_script_lang_ts_decorate([Prop({
  default: false
})], CptvPlayerComponent.prototype, "canGoForwards", void 0);

CptvPlayervue_type_script_lang_ts_decorate([Prop({
  default: false
})], CptvPlayerComponent.prototype, "exportRequested", void 0);

CptvPlayervue_type_script_lang_ts_decorate([Prop({
  default: true
})], CptvPlayerComponent.prototype, "canUseAdvancedControls", void 0);

CptvPlayervue_type_script_lang_ts_decorate([Prop({
  default: true
})], CptvPlayerComponent.prototype, "userFiles", void 0);

CptvPlayervue_type_script_lang_ts_decorate([Ref()], CptvPlayerComponent.prototype, "container", void 0);

CptvPlayervue_type_script_lang_ts_decorate([Ref()], CptvPlayerComponent.prototype, "canvas", void 0);

CptvPlayervue_type_script_lang_ts_decorate([Ref()], CptvPlayerComponent.prototype, "overlayCanvas", void 0);

CptvPlayervue_type_script_lang_ts_decorate([Ref()], CptvPlayerComponent.prototype, "playhead", void 0);

CptvPlayervue_type_script_lang_ts_decorate([Ref()], CptvPlayerComponent.prototype, "valueTooltip", void 0);

CptvPlayervue_type_script_lang_ts_decorate([Ref()], CptvPlayerComponent.prototype, "frameNumField", void 0);

CptvPlayervue_type_script_lang_ts_decorate([Ref()], CptvPlayerComponent.prototype, "ffcSecsAgo", void 0);

CptvPlayervue_type_script_lang_ts_decorate([Watch("exportRequested")], CptvPlayerComponent.prototype, "onExportRequested", null);

CptvPlayervue_type_script_lang_ts_decorate([Watch("userSuppliedFile")], CptvPlayerComponent.prototype, "onUserSuppliedFileChanged", null);

CptvPlayervue_type_script_lang_ts_decorate([Watch("currentTrack")], CptvPlayerComponent.prototype, "onCurrentTrack", null);

CptvPlayervue_type_script_lang_ts_decorate([Watch("recentlyAddedTag")], CptvPlayerComponent.prototype, "onRecentlyAddedTag", null);

CptvPlayervue_type_script_lang_ts_decorate([Watch("cptvUrl")], CptvPlayerComponent.prototype, "onCptvUrl", null);

CptvPlayervue_type_script_lang_ts_decorate([Watch("tracks")], CptvPlayerComponent.prototype, "onTracks", null);

CptvPlayerComponent = CptvPlayervue_type_script_lang_ts_decorate([vue_class_component_esm({
  components: {
    VideoTracksScrubber: src_VideoTracksScrubber,
...
/* harmony default export */ const CptvPlayervue_type_script_lang_ts_ = (CptvPlayerComponent);
;// CONCATENATED MODULE: ./src/CptvPlayer.vue?vue&type=script&lang=ts&
 /* harmony default export */ const src_CptvPlayervue_type_script_lang_ts_ = (CptvPlayervue_type_script_lang_ts_); 
;// CONCATENATED MODULE: ./src/CptvPlayer.vue
...
var CptvPlayer_component = normalizeComponent(
  src_CptvPlayervue_type_script_lang_ts_,
  render,
  staticRenderFns,
  false,
  null,
...
/* harmony default export */ const CptvPlayer = (CptvPlayer_component.exports);
;// CONCATENATED MODULE: ./node_modules/@vue/cli-service/lib/commands/build/entry-lib.js


/* harmony default export */ const entry_lib = (CptvPlayer);
...
/******/ })()
;
//# sourceMappingURL=CptvPlayerVue.common.js.map