...
var VideoTracksScrubbervue_type_template_id_7bb9631a_scoped_true_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{key:"track-scrubber",ref:"scrubber",staticClass:"track-scrubber",style:({
    ...
    width: (_vm.canvasWidth + "px"),
      ...
      opacity: index - 1 === _vm.currentTrack ? 1.0 : 0.5,
...
var VideoTracksScrubbervue_type_template_id_7bb9631a_scoped_true_staticRenderFns = []
...
var VideoTracksScrubber = /*#__PURE__*/function (_Vue) {
  ...
  _createClass(VideoTracksScrubber, [{
    ...
    value: function getWidthForTrack(track) {
      var trackDuration = track.data.end_s - this.timeAdjustmentForBackgroundFrame - (track.data.start_s - this.timeAdjustmentForBackgroundFrame);
    ...
    value: function getOffsetXForTrack(track) {
      return Math.max(this.sidePadding, this.getOffsetForTime(track.data.start_s - this.timeAdjustmentForBackgroundFrame) + this.sidePadding);
    }
  }, {
...
__decorate([Prop({
  default: 0
})], VideoTracksScrubber.prototype, "currentTrack", void 0);
...
var component = normalizeComponent(
  ...
  VideoTracksScrubbervue_type_template_id_7bb9631a_scoped_true_render,
  VideoTracksScrubbervue_type_template_id_7bb9631a_scoped_true_staticRenderFns,
  false,
  null,
  "7bb9631a",
  null
...
var CptvDecoder = /*#__PURE__*/function () {
  function CptvDecoder() {
    ...
    if (typeof window === "undefined") {
      this.decoder = new worker_threads_ignored_.Worker(new URL(/* worker import */ __webpack_require__.p + __webpack_require__.u(647), __webpack_require__.b));
      this.decoder.addListener.bind(this.decoder)("message", onMessage);
    } else {
      this.decoder = new Worker(new URL(/* worker import */ __webpack_require__.p + __webpack_require__.u(268), __webpack_require__.b), {
        type: undefined
      });
  ...
  _createClass(CptvDecoder, [{
    ...
    value: function () {
      var _initWithCptvUrlAndKnownSize = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(url, size) {
        var type;
      ...
      function initWithCptvUrlAndKnownSize(_x, _x2) {
    ...
    key: "initWithCptvUrl",
    value: function () {
      var _initWithCptvUrl = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(url) {
        var type;
    ...
    value: function () {
      var _initWithLocalCptvFile = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(arrayBuffer) {
        var type;
      ...
      function initWithLocalCptvFile(_x4) {
    ...
    value: function () {
      var _initWithCptvFile = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(path) {
        var type;
    ...
    key: "getFileMetadata",
    value: function () {
      var _getFileMetadata = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5(path) {
        var type;
    ...
    value: function () {
      ...
      function getStreamMetadata(_x7) {
    ...
    value: function () {
      var _getBytesMetadata = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee7(arrayBuffer) {
        var type;
    ...
    key: "waitForMessage",
    value: function () {
      var _waitForMessage = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee14(messageType) {
        var _this2 = this;
    ...
    key: "close",
    value: function () {
      var _close = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee15() {
...
;// CONCATENATED MODULE: ../cptv-rs/frameRenderUtils.js
...
var Viridis = Uint32Array.from(viridis_namespaceObject.map(mapRgba));
var Plasma = Uint32Array.from(plasma_namespaceObject.map(mapRgba));
var Inferno = Uint32Array.from(inferno_namespaceObject.map(mapRgba));
var Magma = Uint32Array.from(magma_namespaceObject.map(mapRgba));
...
var renderFrameIntoFrameBuffer = function renderFrameIntoFrameBuffer(frameBuffer, frameData, colourMap, min, max) {
  var range = max - min;
  var frameBufferView = new Uint32Array(frameBuffer.buffer);

  for (var _i = 0; _i < frameBuffer.length; _i++) {
    var index = (frameData[_i] - min) / range * 255.0;
    var indexUpper = Math.ceil(index);
    frameBufferView[_i] = colourMap[indexUpper];
  }
};
var getFrameIndexAtTime = function getFrameIndexAtTime(time, duration, fps) {
  var totalFramesIncludingBackground = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : false;
  var hasBackgroundFrame = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : false;
...
var getAuthoritativeTagForTrack = function getAuthoritativeTagForTrack(trackTags) {
  var userTags = trackTags.filter(function (tag) {
    return tag.user !== undefined && tag.user !== null || tag.User !== undefined && tag.User !== null;
  });
    ...
    return {
      ...
      positions: data.positions.map(function (_ref2) {
        var _ref3 = _slicedToArray(_ref2, 2),
            time = _ref3[0],
            _ref3$ = _slicedToArray(_ref3[1], 4),
            left = _ref3$[0],
            top = _ref3$[1],
            right = _ref3$[2],
            bottom = _ref3$[3];

        return [frameAtTime(time - timeOffset), time - timeOffset, [Math.max(0, left - padding), Math.max(0, top - padding), right + padding, bottom + padding]];
      })
    };
...
;// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js??clonedRuleSet-40[0].rules[0].use[0]!./node_modules/thread-loader/dist/cjs.js!./node_modules/babel-loader/lib/index.js!./node_modules/ts-loader/index.js??clonedRuleSet-40[0].rules[0].use[3]!./node_modules/cache-loader/dist/cjs.js??ruleSet[0].rules[0].use[0]!./node_modules/vue-loader-v15/lib/index.js??vue-loader-options!./src/CptvPlayer.vue?vue&type=script&lang=ts&
...
var cptvDecoder = new CptvDecoder();
  ...
  _createClass(CptvPlayerComponent, [{
    ...
    get: function get() {
      ...
      return Math.max.apply(Math, _toConsumableArray(this.tracks.map(function (track) {
        return track.data.end_s - _this2.timeAdjustmentForBackgroundFrame;
    ...
    value: function beforeDestroy() {
      ...
      if (window.matchMedia) {
        var match = window.matchMedia("screen and (min-resolution: 2dppx)");
    ...
    value: function () {
      var _onExportRequested = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3() {
        return regeneratorRuntime.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
    ...
    value: function () {
      var _onUserSuppliedFileChanged = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4() {
        var buffer;
        return regeneratorRuntime.wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              ...
              case 17:
                this.streamLoadError = _context4.sent;
                _context4.next = 20;
    ...
    value: function onePastLastFrameForTrack(trackIndex) {
    ...
    key: "initPlayer",
    value: function () {
      var _initPlayer = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5() {
        return regeneratorRuntime.wrap(function _callee5$(_context5) {
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
    ...
    key: "loadCptvFile",
    value: function () {
      var _loadCptvFile = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee6() {
        var localFile,
            playImmediately,
            _args6 = arguments;
        return regeneratorRuntime.wrap(function _callee6$(_context6) {
          while (1) {
            switch (_context6.prev = _context6.next) {
              case 0:
                localFile = _args6.length > 0 && _args6[0] !== undefined ? _args6[0] : null;
                playImmediately = _args6.length > 1 && _args6[1] !== undefined ? _args6[1] : true;
              ...
              case 6:
                this.loadedStream = _context6.sent;
              ...
              case 34:
                ...
                this.header = _context6.t0.freeze.call(_context6.t0, _context6.t1);
                this.setFrameInfo(0);
      ...
      if (this.currentTrack && (!this.playing || force)) {
        if (this.currentTrack.start_s !== undefined) {
          if (this.processedTracks && this.currentTrack.trackIndex < Object.keys(this.processedTracks).length) {
            cancelAnimationFrame(this.animationFrame);
            this.animationTick = 0;
            this.setTimeAndRedraw(-1, this.firstFrameForTrack(this.currentTrack.trackIndex));
        ...
        if (this.currentTrack.end_s !== undefined) {
          ...
          this.stopAtFrame = this.onePastLastFrameForTrack(this.currentTrack.trackIndex);
        } else {
    ...
    key: "stepForward",
    value: function () {
      var _stepForward = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee7() {
        var canAdvance;
        return regeneratorRuntime.wrap(function _callee7$(_context7) {
          while (1) {
            switch (_context7.prev = _context7.next) {
          ...
          while (1) {
            switch (_context8.prev = _context8.next) {
              case 0:
                ...
                this.pause();
                this.animationTick = 0;
                firstFrame = this.hasBackgroundFrame ? 1 : 0;
                _context8.next = 6;
    ...
    value: function () {
      var _clickOverlayCanvas = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee9(event) {
        var canvasOffset, x, y, hitTrackIndex, hitTrack;
        return regeneratorRuntime.wrap(function _callee9$(_context9) {
          while (1) {
            switch (_context9.prev = _context9.next) {
              case 0:
    ...
    value: function () {
      var _fetchRenderAdvanceFrame = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee10() {
        var canAdvance;
        return regeneratorRuntime.wrap(function _callee10$(_context10) {
          while (1) {
            switch (_context10.prev = _context10.next) {
        ...
        return regeneratorRuntime.wrap(function _callee11$(_context11) {
          while (1) {
            switch (_context11.prev = _context11.next) {
              ...
              case 31:
                this.streamLoadError = _context11.sent;
                _context11.next = 34;
                return cptvDecoder.close();
    ...
    value: function renderFrame(frameData, frameNum) {
      ...
      if (this.canvas && this.header) {
        ...
        var _this$minMaxForFrame3 = this.minMaxForFrame(frameData),
            _this$minMaxForFrame4 = _slicedToArray(_this$minMaxForFrame3, 2),
    ...
    value: function () {
      var _incrementPalette = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee13() {
        var paletteName;
        return regeneratorRuntime.wrap(function _callee13$(_context13) {
          while (1) {
            switch (_context13.prev = _context13.next) {
    ...
    value: function renderOverlay(context, scale, timeSinceFFCSeconds, isExporting, frameNum, trackExportOptions) {
      if (context) {
          ...
          try {
            for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
              var _step2$value = _slicedToArray(_step2.value, 2),
                  _trackIndex = _step2$value[0],
                  trackBox = _step2$value[1];

              if (this.currentTrack.trackIndex !== Number(_trackIndex)) {
                if (!trackExportOptions || trackExportOptions[Number(_trackIndex)].displayInExport) {
                  var box = trackBox;
                  this.drawRectWithText(context, Number(_trackIndex), box.rect, box.what, isExporting);
                }
              }
            }
          } catch (err) {
        ...
        for (var _i = 0, _frameTracks = frameTracks; _i < _frameTracks.length; _i++) {
          var _frameTracks$_i = _slicedToArray(_frameTracks[_i], 2),
              _trackIndex2 = _frameTracks$_i[0],
              _trackBox = _frameTracks$_i[1];

          if (this.currentTrack && this.currentTrack.trackIndex === Number(_trackIndex2)) {
            if (!trackExportOptions || trackExportOptions[Number(_trackIndex2)].displayInExport) {
              var _box = _trackBox;
              this.drawRectWithText(context, Number(_trackIndex2), _box.rect, _box.what, isExporting);
            }
          }
        }
    ...
    value: function drawRectWithText(context, trackIndex, dims, what, isExporting) {
      if (!this.header) {
        return;
      }

      var selected = this.currentTrack && this.currentTrack.trackIndex === trackIndex || isExporting;
    ...
    value: function () {
      var _toggleBackground = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee14() {
    ...
    value: function getTrackIndexAtPosition(x, y) {
      ...
      for (var _i2 = 0, _Object$entries = Object.entries(tracks); _i2 < _Object$entries.length; _i2++) {
        var _Object$entries$_i = _slicedToArray(_Object$entries[_i2], 2),
            trackIndex = _Object$entries$_i[0],
        ...
        if (left <= x && right > x && top <= y && bottom > y) {
          ...
          if (this.currentTrack && Number(trackIndex) === this.currentTrack.trackIndex) {
            continue;
          }
    ...
    value: function () {
      var _setTimeAndRedraw = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee15() {
        var time,
            frameNum,
            totalFrames,
            _args15 = arguments;
        return regeneratorRuntime.wrap(function _callee15$(_context15) {
          while (1) {
            switch (_context15.prev = _context15.next) {
              case 0:
                time = _args15.length > 0 && _args15[0] !== undefined ? _args15[0] : -1;
                frameNum = _args15.length > 1 && _args15[1] !== undefined ? _args15[1] : -1;
    ...
    value: function () {
      var _renderCurrentFrame = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee16() {
        var force,
            frameNum,
            frame,
            gotFrame,
        ...
        return regeneratorRuntime.wrap(function _callee16$(_context16) {
          while (1) {
            switch (_context16.prev = _context16.next) {
              ...
              case 5:
                this.loadProgress = _context16.sent;
              ...
              case 25:
                this.streamLoadError = _context16.sent;
                _context16.next = 28;
                return cptvDecoder.close();
    ...
    key: "play",
    value: function () {
      var _play = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee17() {
    ...
    key: "togglePlayback",
    value: function () {
      var _togglePlayback = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee18() {
...
/******/ 	var __webpack_exports__ = __webpack_require__(3818);
