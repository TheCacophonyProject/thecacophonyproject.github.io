...
;// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"e3b2d552-vue-loader-template"}!./node_modules/vue-loader-v15/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ruleSet[0].rules[0].use[0]!./node_modules/vue-loader-v15/lib/index.js??vue-loader-options!./src/CptvPlayer.vue?vue&type=template&id=424a0972&
...
;// CONCATENATED MODULE: ./node_modules/cptv-decoder/index.js
...
class CptvDecoder {
  constructor() {
    ...
    if (typeof window === "undefined") {
      this.decoder = new worker_threads_ignored_.Worker(new URL(/* worker import */ __webpack_require__.p + __webpack_require__.u(372), __webpack_require__.b));
      this.decoder.addListener.bind(this.decoder)("message", onMessage);
    } else {
      this.decoder = new Worker(new URL(/* worker import */ __webpack_require__.p + __webpack_require__.u(146), __webpack_require__.b), {type: undefined});
...
;// CONCATENATED MODULE: ./node_modules/scale-color-perceptual/rgb/viridis.json
...
;// CONCATENATED MODULE: ./node_modules/scale-color-perceptual/rgb/plasma.json
...
;// CONCATENATED MODULE: ./node_modules/scale-color-perceptual/rgb/magma.json
...
;// CONCATENATED MODULE: ./node_modules/scale-color-perceptual/rgb/inferno.json
...
;// CONCATENATED MODULE: ./node_modules/cptv-decoder/DefaultColourmap.js
/* harmony default export */ const DefaultColourmap = ([
    [68, 1, 84],
    [68, 3, 87],
    [69, 6, 90],
    [70, 9, 92],
...
;// CONCATENATED MODULE: ./node_modules/cptv-decoder/frameRenderUtils.js
...
const Viridis = Uint32Array.from(viridis_namespaceObject.map(mapRgba));
const Plasma = Uint32Array.from(plasma_namespaceObject.map(mapRgba));
const Inferno = Uint32Array.from(inferno_namespaceObject.map(mapRgba));
const Magma = Uint32Array.from(magma_namespaceObject.map(mapRgba));
...
const renderFrameIntoFrameBuffer = (frameBuffer, frameData, colourMap, min, max) => {
  const range = max - min;
...
var Mp4Encoder = /*#__PURE__*/function () {
  function Mp4Encoder() {
    ...
    this.encoder = new Worker(new URL(/* worker import */ __webpack_require__.p + __webpack_require__.u(57), __webpack_require__.b));
...
/******/ 	var __webpack_exports__ = __webpack_require__(4283);
