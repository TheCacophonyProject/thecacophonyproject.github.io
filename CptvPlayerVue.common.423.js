((typeof self !== 'undefined' ? self : this)["webpackChunkcptv_player_vue"] = (typeof self !== 'undefined' ? self : this)["webpackChunkcptv_player_vue"] || []).push([[423],{
...
let wasm;
const { TextDecoder, TextEncoder } = __webpack_require__(6020)(String.raw`util`);
...
const path = __webpack_require__(3336).join(__dirname, 'index_bg.wasm');
const bytes = __webpack_require__(8589).readFileSync(path);
...
//# sourceMappingURL=CptvPlayerVue.common.423.js.map